...
function Swemwbs(patient_id) {
    taskcommon.BaseTask.call(this, patient_id); // call base constructor
}

lang.inheritPrototype(Swemwbs, taskcommon.BaseTask);
lang.extendPrototype(Swemwbs, {
    ...
    getDetail: function () {
        return (
            taskcommon.valueDetail(this, "swemwbs_q", "", ": ", "q", 1,
                                   nquestions) +
            "\n" +
            this.getSummary()
        );
        ...
        pages = [
            {
                ...
                elements: [
                    {
                        type: "QuestionText",
                        text: L('wemwbs_prompt'),  // shares with WEMWBS
                        bold: true
                    },
                    {
                        type: "QuestionMCQGrid",
                        options: [
                            // Share answers with the WEMWBS
