...
lang.extendPrototype(Ace3, {
    ...
    getAttnScore: function () {
        return (
            taskcommon.totalScore(this, "attn_time", 1, 5) +
            taskcommon.totalScore(this, "attn_place", 1, 5) +
            taskcommon.totalScore(this, "attn_repeat_word", 1, 3) +
            taskcommon.totalScore(this, "attn_serial7_subtraction", 1, 5)
        );
    },
    ...
    getMemScore: function () {
        return (
            taskcommon.totalScore(this, "mem_recall_word", 1, 3) +
            taskcommon.totalScore(this, "mem_repeat_address_trial3_", 1, 7) +
            taskcommon.totalScore(this, "mem_famous", 1, 4) +
            taskcommon.totalScore(this, "mem_recall_address", 1, 7) +
    ...
    getFollowCommandScore: function () {
        ...
        return taskcommon.totalScore(this, "lang_follow_command", 1, 3);
    },

    getRepeatWordScore: function () {
        var n = taskcommon.totalScore(this, "lang_repeat_word", 1, 4);
    ...
    getLangScore: function () {
        return (
            ...
            taskcommon.totalScore(this, "lang_write_sentences_point", 1, 2) +
            this.getRepeatWordScore() + // 2 points
            taskcommon.totalScore(this, "lang_repeat_sentence", 1, 2) +
            taskcommon.totalScore(this, "lang_name_picture", 1, 12) +
            taskcommon.totalScore(this, "lang_identify_concept", 1, 4) +
    ...
    getVisuospatialScore: function () {
        return (
            ...
            taskcommon.totalScore(this, "vsp_count_dots", 1, 4) +
            taskcommon.totalScore(this, "vsp_identify_letter", 1, 4)
        );
    },
    ...
    isComplete: function () {
        // In task order:
        return (
            taskcommon.isComplete(this, "attn_time", 1, 5) &&
            taskcommon.isComplete(this, "attn_place", 1, 5) &&
            taskcommon.isComplete(this, "attn_repeat_word", 1, 3) &&
            taskcommon.isComplete(this, "attn_serial7_subtraction", 1, 5) &&
            taskcommon.isComplete(this, "mem_recall_word", 1, 3) &&
            ...
            taskcommon.isComplete(this, "mem_repeat_address_trial3_", 1, 7) &&
            taskcommon.isComplete(this, "mem_famous", 1, 4) &&
            this.lang_follow_command_practice !== null &&
            (this.lang_follow_command_practice === 0 ||
                    taskcommon.isComplete(this, "lang_follow_command", 1, 3)) &&
            taskcommon.isComplete(this, "lang_write_sentences_point", 1, 2) &&
            taskcommon.isComplete(this, "lang_repeat_word", 1, 4) &&
            taskcommon.isComplete(this, "lang_repeat_sentence", 1, 2) &&
            taskcommon.isComplete(this, "lang_name_picture", 1, 12) &&
            taskcommon.isComplete(this, "lang_identify_concept", 1, 4) &&
            this.lang_read_words_aloud !== null &&
            this.vsp_copy_infinity !== null &&
            this.vsp_copy_cube !== null &&
            this.vsp_draw_clock !== null &&
            taskcommon.isComplete(this, "vsp_count_dots", 1, 4) &&
            taskcommon.isComplete(this, "vsp_identify_letter", 1, 4) &&
            taskcommon.isComplete(this, "mem_recall_address", 1, 7) &&
