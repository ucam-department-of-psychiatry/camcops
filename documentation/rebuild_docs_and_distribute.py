#!/usr/bin/env python
# documentation/rebuild_docs_and_distribute.py
...
SERVER_DOCS_DIR = os.path.join(CAMCOPS_ROOT_DIR, "server", "camcops_server",
                               "documentation_copy")
# TABLET_DOCS_DIR = os.path.join(CAMCOPS_ROOT_DIR, "tablet_qt",
#                                "documentation_copy")
WEBSITE_DOCS_DIR = os.path.join(CAMCOPS_ROOT_DIR, "website", "documentation")

DEST_DIRS = [
    # SERVER_DOCS_DIR,
    # WEBSITE_DOCS_DIR,  # uncomment when ready!
]
...
# Make HTML version of documentation
os.chdir(THIS_DIR)
