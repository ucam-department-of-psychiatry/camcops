...
where CONFIG is the filename of your configuration file. (Again, use `sudo` as
above if your configuration file requires privileged access to read.)
...
Here's an example, which you would edit into the Apache config file
[#linuxflavours]_:
