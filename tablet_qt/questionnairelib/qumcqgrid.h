...
protected:
    QVector<QuestionWithOneField>
        m_question_field_pairs;  // Question/field mapping
    ...
    QVector<int>
        m_option_min_widths_px;  // minimum width in pixels for option columns
    ...
    QVector<QVector<QPointer<BooleanWidget>>>
        m_widgets;  // our response widgets
