...
protected:
    ...
    bool
        m_convert_for_real_field;  // translate to real numbers in slider space?
    ...
    QSlider::TickPosition
        m_tick_position;  // ticks above/below/both/none, or left/right/both/none?
    bool m_use_default_labels;  // use default numerical labels?
    QMap<int, QString>
        m_tick_labels;  // manually specified position/label pairs
    QSlider::TickPosition
        m_tick_label_position;  // labels above/below/both/none, or left/right/both/none?
    ...
    QSharedPointer<QTimer>
        m_timer;  // timer to delay writes for visual performance
};
