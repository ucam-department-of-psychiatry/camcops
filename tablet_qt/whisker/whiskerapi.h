...
struct Brush
{
    ...
    whiskerconstants::BrushHatchStyle
        hatch_style;  // for hatched: e.g. horizontal, fdiagonal, cross
};
...
public:
    ...
    QPoint
        pos;  // Coordinate of the bitmap (meaning depends on valign/halign).
    ...
    whiskerconstants::VerticalAlign valign
        = whiskerconstants::VerticalAlign::Top;  // vertical alignment
    whiskerconstants::HorizontalAlign halign
        = whiskerconstants::HorizontalAlign::Left;  // horizontal alignment
};
...
public:
    ...
    QColor bg_colour
        = whiskerconstants::BLACK;  // Background colour (if opaque)
    whiskerconstants::TextVerticalAlign valign
        = whiskerconstants::TextVerticalAlign::Top;  // vertical alignment
    whiskerconstants::TextHorizontalAlign halign
        = whiskerconstants::TextHorizontalAlign::Left;  // horizontal alignment
};
...
public:
    ...
    // See Whisker docs.
    QPoint
        pos;  // Coordinates of the video (meaning depends on valign/halign).
    QString filename;  // Filename, as seen by the Whisker server.
    bool loop = false;  // Loop once it's finished?
    whiskerconstants::VideoPlayMode playmode
        = whiskerconstants::VideoPlayMode::Wait;  // How to start?
    ...
    whiskerconstants::HorizontalAlign halign
        = whiskerconstants::HorizontalAlign::Left;  // horizontal alignment
    QColor bg_colour = whiskerconstants::
        BLACK;  // background colour, e.g. before playback (see docs)
};
