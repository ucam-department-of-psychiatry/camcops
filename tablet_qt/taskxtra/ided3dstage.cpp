    ...
    m_n_possible_locations(0)
{
    ...
    // More keys
    addField(
        FN_STAGE, QMetaType::fromType<int>(), true
    ...
    addField(
        FN_CORRECT_EXEMPLAR, QMetaType::fromType<int>()
    );  // was string prior to 2.0.0
    addField(
        FN_INCORRECT_EXEMPLAR, QMetaType::fromType<int>()
    );  // was string prior to 2.0.0
    addField(FN_CORRECT_STIMULUS_SHAPES, QMetaType::fromType<QVector<int>>());
    addField(
        FN_CORRECT_STIMULUS_COLOURS, QMetaType::fromType<QVector<int>>()
    );  // was string prior to 2.0.0
