...
const QString
    DiagnosisIcd10Item::DIAGNOSIS_ICD10_ITEM_TABLENAME("diagnosis_icd10_item");
...
DiagnosisIcd10Item::DiagnosisIcd10Item(
    ...
    DiagnosisItemBase(
        app, db, DIAGNOSIS_ICD10_ITEM_TABLENAME, FK_NAME, load_pk
    )
{
}
...
DiagnosisIcd10Item::DiagnosisIcd10Item(
    ...
    DiagnosisItemBase(
        owner_fk, app, db, DIAGNOSIS_ICD10_ITEM_TABLENAME, FK_NAME
    )
