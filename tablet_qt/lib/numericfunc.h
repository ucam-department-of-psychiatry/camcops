...
namespace Numeric {
    ...
    bool extendedIntegerMustExceed(int number, int top);
    bool extendedIntegerMustBeLessThan(int number, int bottom);
    ...
    bool extendedDoubleMustExceed(double number, double top);
    bool extendedDoubleMustBeLessThan(double number, double bottom);
}
