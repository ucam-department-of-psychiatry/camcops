...
#include "tasks/diagnosisicd9cmitem.h"
#include "tasklib/taskfactory.h"

const QString DIAGNOSIS_ICD9CM_TABLENAME("diagnosis_icd9cm");
...
{
    return DiagnosisItemBasePtr(new DiagnosisIcd9CMItem(m_app, m_db));
}
