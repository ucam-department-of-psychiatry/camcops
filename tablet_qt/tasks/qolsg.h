...
protected:
    ...
    void thanks();
    void clearScene();
    graphicsfunc::AdjustablePieAndProxy
        makePie(const QPointF& centre, int n_sectors);
    ...
    void showGambleInstruction(
        bool lottery_on_left, const QString& category_chosen
    );
