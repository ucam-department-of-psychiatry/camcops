...
CardinalExpectationDetection::CardinalExpectationDetection(
    ...
    Task(
        app, db, CARDINALEXPDET_TABLENAME, false, false, false
    )  // ... anon, clin, resp
{
    // Config
    ...
    addField(
        FN_VISUAL_BACKGROUND_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    addField(
        FN_VISUAL_TARGET_0_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    addField(
        FN_VISUAL_TARGET_1_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    addField(
        FN_AUDITORY_BACKGROUND_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    addField(
        FN_AUDITORY_TARGET_0_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    addField(
        FN_AUDITORY_TARGET_1_INTENSITY, QMetaType::fromType<double>()
    );  // 0 to 1
    // ... ITI
...
QVector<DatabaseObjectPtr>
    CardinalExpectationDetection::getAncillarySpecimens() const
{
...
QVector<DatabaseObjectPtr>
    CardinalExpectationDetection::getAllAncillary() const
{
