...
{
    addField(FN_Q1_AGE_FIRST_INFLAMMATORY_SX, QMetaType::Int);
    addField(FN_Q2_WHEN_PSYCH_SX_STARTED, QMetaType::Int);
    addField(FN_Q3_WORST_SYMPTOM_LAST_MONTH, QMetaType::Int);
    addField(FN_Q4A_SYMPTOM_TIMING, QMetaType::Int);
    addField(FN_Q4B_DAYS_PSYCH_BEFORE_PHYS, QMetaType::Int);
    addField(FN_Q4C_DAYS_PSYCH_AFTER_PHYS, QMetaType::Int);
    addField(FN_Q5_ANTIBIOTICS, QMetaType::Bool);
    addField(FN_Q6A_INPATIENT_LAST_Y, QMetaType::Bool);
    addField(FN_Q6B_INPATIENT_WEEKS, QMetaType::Int);
    addField(FN_Q7A_SX_LAST_2Y, QMetaType::Bool);
    addField(FN_Q7B_VARIABILITY, QMetaType::Int);
    addField(FN_Q8_SMOKING, QMetaType::Int);
    addField(FN_Q9_PREGNANT, QMetaType::Bool);
    addField(FN_Q10A_EFFECTIVE_RX_PHYSICAL, QMetaType::QString);
    addField(FN_Q10B_EFFECTIVE_RX_PSYCH, QMetaType::QString);
    addField(FN_Q11A_PH_DEPRESSION, QMetaType::Bool);
    addField(FN_Q11B_PH_BIPOLAR, QMetaType::Bool);
    addField(FN_Q11C_PH_SCHIZOPHRENIA, QMetaType::Bool);
    addField(FN_Q11D_PH_AUTISTIC_SPECTRUM, QMetaType::Bool);
    addField(FN_Q11E_PH_PTSD, QMetaType::Bool);
    addField(FN_Q11F_PH_OTHER_ANXIETY, QMetaType::Bool);
    addField(FN_Q11G_PH_PERSONALITY_DISORDER, QMetaType::Bool);
    addField(FN_Q11H_PH_OTHER_PSYCH, QMetaType::Bool);
    addField(FN_Q11H_PH_OTHER_DETAIL, QMetaType::QString);
    addField(FN_Q12A_FH_DEPRESSION, QMetaType::Bool);
    addField(FN_Q12B_FH_BIPOLAR, QMetaType::Bool);
    addField(FN_Q12C_FH_SCHIZOPHRENIA, QMetaType::Bool);
    addField(FN_Q12D_FH_AUTISTIC_SPECTRUM, QMetaType::Bool);
    addField(FN_Q12E_FH_PTSD, QMetaType::Bool);
    addField(FN_Q12F_FH_OTHER_ANXIETY, QMetaType::Bool);
    addField(FN_Q12G_FH_PERSONALITY_DISORDER, QMetaType::Bool);
    addField(FN_Q12H_FH_OTHER_PSYCH, QMetaType::Bool);
    addField(FN_Q12H_FH_OTHER_DETAIL, QMetaType::QString);
    addField(FN_Q13A_BEHCET, QMetaType::Bool);
    addField(FN_Q13B_ORAL_ULCERS, QMetaType::Bool);
    addField(FN_Q13C_ORAL_AGE_FIRST, QMetaType::Int);
    addField(FN_Q13D_ORAL_SCARRING, QMetaType::Bool);
    addField(FN_Q13E_GENITAL_ULCERS, QMetaType::Bool);
    addField(FN_Q13F_GENITAL_AGE_FIRST, QMetaType::Int);
    addField(FN_Q13G_GENITAL_SCARRING, QMetaType::Bool);
