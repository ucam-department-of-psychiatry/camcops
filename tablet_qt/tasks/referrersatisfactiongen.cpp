...
const QString REF_SATIS_GEN_TABLENAME("ref_satis_gen");
...
ReferrerSatisfactionGen::ReferrerSatisfactionGen(CamcopsApp& app, const QSqlDatabase& db, int load_pk) :
...
OpenableWidget* ReferrerSatisfactionGen::editor(bool read_only)
{
