...
const QString
    AceFamily::FN_REMOTE_ADMINISTRATION(QStringLiteral("remote_administration")
    );
...
const QString
    AceFamily::FN_FLUENCY_ANIMALS_SCORE(QStringLiteral("fluency_animals_score")
    );
...
const QString
    AceFamily::TAG_EL_CHOOSE_TASK_VERSION(QStringLiteral("choose_addr_version")
    );
const QString
...
AceFamily::AceFamily(
    ...
    Task(
        app, db, tablename, false, true, false, parent
    ),  // ... anon, clin, resp
