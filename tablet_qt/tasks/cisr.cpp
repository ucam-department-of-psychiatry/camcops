...
const QMap<CQ, QPair<int, int>> QUESTIONS_MULTIWAY{
    ...
    {CQ::WEIGHT4_INCREASE_PAST_MONTH,
     {1, 2}},  // may be modified to 3 if female
...
const QMap<CQ, QPair<int, int>> QUESTIONS_MULTIWAY_WITH_EXTRA_STEM{
    ...
    {CQ::EMPTYPE,
     {1,
      7}},  // 7 includes our additional "not applicable" + "prefer not to say"
...
QString Cisr::suicideIntent(const Cisr::CisrResult& result, bool with_warning)
    const
{
    QString intent;
    if (result.incomplete) {
