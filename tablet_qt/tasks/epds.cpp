...
const int CUTOFF_1_GREATER_OR_EQUAL
    = 10;  // Cox et al. 1987, PubMed ID 3651732.
const int CUTOFF_2_GREATER_OR_EQUAL
    = 13;  // Cox et al. 1987, PubMed ID 3651732.

const QVector<int> REVERSE_QUESTIONS{
    3, 5, 6, 7, 8, 9, 10};  // only 1, 2, 4 the other way
...
Epds::Epds(CamcopsApp& app, DatabaseManager& db, const int load_pk) :
    Task(
        app, db, EPDS_TABLENAME, false, false, false
    ),  // ... anon, clin, resp
