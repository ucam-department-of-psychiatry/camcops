...
public:
    ...
    // ------------------------------------------------------------------------
    QVariant score(int question) const;  // returns int or null QVariant
    QVariant meanScore(const QVector<int>& questions) const;
    QVariant subscale1AvoidanceRuleBased() const;
    QVariant subscale2WeightControl() const;
    QVariant subscale3MoodImprovement() const;
