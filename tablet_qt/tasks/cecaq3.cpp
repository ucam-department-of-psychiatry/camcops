...
{
    addField(S1A_MOTHERFIGURE_BIRTHMOTHER, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_STEPMOTHER, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_FEMALERELATIVE, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_FEMALERELATIVE_DETAIL, QMetaType::QString);
    addField(S1A_MOTHERFIGURE_FAMILYFRIEND, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_FOSTERMOTHER, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_ADOPTIVEMOTHER, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_OTHER, QMetaType::Bool);
    addField(S1A_MOTHERFIGURE_OTHER_DETAIL, QMetaType::QString);
    addField(S1A_FATHERFIGURE_BIRTHFATHER, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_STEPFATHER, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_MALERELATIVE, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_MALERELATIVE_DETAIL, QMetaType::QString);
    addField(S1A_FATHERFIGURE_FAMILYFRIEND, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_FOSTERFATHER, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_ADOPTIVEFATHER, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_OTHER, QMetaType::Bool);
    addField(S1A_FATHERFIGURE_OTHER_DETAIL, QMetaType::QString);
    addField(S1B_INSTITUTION, QMetaType::Bool);
    addField(S1B_INSTITUTION_TIME_YEARS, QMetaType::Double);
    addField(S1C_MOTHER_DIED, QMetaType::Bool);
    addField(S1C_FATHER_DIED, QMetaType::Bool);
    addField(S1C_MOTHER_DIED_SUBJECT_AGED, QMetaType::Double);
    addField(S1C_FATHER_DIED_SUBJECT_AGED, QMetaType::Double);
    addField(S1C_SEPARATED_FROM_MOTHER, QMetaType::Bool);
    addField(S1C_SEPARATED_FROM_FATHER, QMetaType::Bool);
    addField(S1C_FIRST_SEPARATED_FROM_MOTHER_AGED, QMetaType::Double);
    addField(S1C_FIRST_SEPARATED_FROM_FATHER_AGED, QMetaType::Double);
    addField(S1C_MOTHER_HOW_LONG_FIRST_SEPARATION_YEARS, QMetaType::Double);
    addField(S1C_FATHER_HOW_LONG_FIRST_SEPARATION_YEARS, QMetaType::Double);
    addField(S1C_MOTHER_SEPARATION_REASON, QMetaType::Int);
    addField(S1C_FATHER_SEPARATION_REASON, QMetaType::Int);
    addField(S1C_DESCRIBE_EXPERIENCE, QMetaType::QString);
    addField(S2A_WHICH_MOTHER_FIGURE, QMetaType::Int);
    addField(S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL, QMetaType::QString);
    addField(S2A_Q1, QMetaType::Int);
    addField(S2A_Q2, QMetaType::Int);
    addField(S2A_Q3, QMetaType::Int);
    addField(S2A_Q4, QMetaType::Int);
    addField(S2A_Q5, QMetaType::Int);
    addField(S2A_Q6, QMetaType::Int);
    addField(S2A_Q7, QMetaType::Int);
    addField(S2A_Q8, QMetaType::Int);
    addField(S2A_Q9, QMetaType::Int);
    addField(S2A_Q10, QMetaType::Int);
    addField(S2A_Q11, QMetaType::Int);
    addField(S2A_Q12, QMetaType::Int);
    addField(S2A_Q13, QMetaType::Int);
    addField(S2A_Q14, QMetaType::Int);
    addField(S2A_Q15, QMetaType::Int);
    addField(S2A_Q16, QMetaType::Int);
    addField(S2A_EXTRA, QMetaType::QString);
    addField(S2B_Q1, QMetaType::Int);
    addField(S2B_Q2, QMetaType::Int);
    addField(S2B_Q3, QMetaType::Int);
    addField(S2B_Q4, QMetaType::Int);
    addField(S2B_Q5, QMetaType::Int);
    addField(S2B_Q6, QMetaType::Int);
    addField(S2B_Q7, QMetaType::Int);
    addField(S2B_Q8, QMetaType::Int);
    addField(S2B_Q9, QMetaType::Int);
    addField(S2B_Q10, QMetaType::Int);
    addField(S2B_Q11, QMetaType::Int);
    addField(S2B_Q12, QMetaType::Int);
    addField(S2B_Q13, QMetaType::Int);
    addField(S2B_Q14, QMetaType::Int);
    addField(S2B_Q15, QMetaType::Int);
    addField(S2B_Q16, QMetaType::Int);
    addField(S2B_Q17, QMetaType::Int);
    addField(S2B_Q1_FREQUENCY, QMetaType::Int);
    addField(S2B_Q2_FREQUENCY, QMetaType::Int);
    addField(S2B_Q3_FREQUENCY, QMetaType::Int);
    addField(S2B_Q4_FREQUENCY, QMetaType::Int);
    addField(S2B_Q5_FREQUENCY, QMetaType::Int);
    addField(S2B_Q6_FREQUENCY, QMetaType::Int);
    addField(S2B_Q7_FREQUENCY, QMetaType::Int);
    addField(S2B_Q8_FREQUENCY, QMetaType::Int);
    addField(S2B_Q9_FREQUENCY, QMetaType::Int);
    addField(S2B_Q10_FREQUENCY, QMetaType::Int);
    addField(S2B_Q11_FREQUENCY, QMetaType::Int);
    addField(S2B_Q12_FREQUENCY, QMetaType::Int);
    addField(S2B_Q13_FREQUENCY, QMetaType::Int);
    addField(S2B_Q14_FREQUENCY, QMetaType::Int);
    addField(S2B_Q15_FREQUENCY, QMetaType::Int);
    addField(S2B_Q16_FREQUENCY, QMetaType::Int);
    addField(S2B_Q17_FREQUENCY, QMetaType::Int);
    addField(S2B_AGE_BEGAN, QMetaType::Double);
    addField(S2B_EXTRA, QMetaType::QString);
    addField(S3A_WHICH_FATHER_FIGURE, QMetaType::Int);
    addField(S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL, QMetaType::QString);
    addField(S3A_Q1, QMetaType::Int);
    addField(S3A_Q2, QMetaType::Int);
    addField(S3A_Q3, QMetaType::Int);
    addField(S3A_Q4, QMetaType::Int);
    addField(S3A_Q5, QMetaType::Int);
    addField(S3A_Q6, QMetaType::Int);
    addField(S3A_Q7, QMetaType::Int);
    addField(S3A_Q8, QMetaType::Int);
    addField(S3A_Q9, QMetaType::Int);
    addField(S3A_Q10, QMetaType::Int);
    addField(S3A_Q11, QMetaType::Int);
    addField(S3A_Q12, QMetaType::Int);
    addField(S3A_Q13, QMetaType::Int);
    addField(S3A_Q14, QMetaType::Int);
    addField(S3A_Q15, QMetaType::Int);
    addField(S3A_Q16, QMetaType::Int);
    addField(S3A_EXTRA, QMetaType::QString);
    addField(S3B_Q1, QMetaType::Int);
    addField(S3B_Q2, QMetaType::Int);
    addField(S3B_Q3, QMetaType::Int);
    addField(S3B_Q4, QMetaType::Int);
    addField(S3B_Q5, QMetaType::Int);
    addField(S3B_Q6, QMetaType::Int);
    addField(S3B_Q7, QMetaType::Int);
    addField(S3B_Q8, QMetaType::Int);
    addField(S3B_Q9, QMetaType::Int);
    addField(S3B_Q10, QMetaType::Int);
    addField(S3B_Q11, QMetaType::Int);
    addField(S3B_Q12, QMetaType::Int);
    addField(S3B_Q13, QMetaType::Int);
    addField(S3B_Q14, QMetaType::Int);
    addField(S3B_Q15, QMetaType::Int);
    addField(S3B_Q16, QMetaType::Int);
    addField(S3B_Q17, QMetaType::Int);
    addField(S3B_Q1_FREQUENCY, QMetaType::Int);
    addField(S3B_Q2_FREQUENCY, QMetaType::Int);
    addField(S3B_Q3_FREQUENCY, QMetaType::Int);
    addField(S3B_Q4_FREQUENCY, QMetaType::Int);
    addField(S3B_Q5_FREQUENCY, QMetaType::Int);
    addField(S3B_Q6_FREQUENCY, QMetaType::Int);
    addField(S3B_Q7_FREQUENCY, QMetaType::Int);
    addField(S3B_Q8_FREQUENCY, QMetaType::Int);
    addField(S3B_Q9_FREQUENCY, QMetaType::Int);
    addField(S3B_Q10_FREQUENCY, QMetaType::Int);
    addField(S3B_Q11_FREQUENCY, QMetaType::Int);
    addField(S3B_Q12_FREQUENCY, QMetaType::Int);
    addField(S3B_Q13_FREQUENCY, QMetaType::Int);
    addField(S3B_Q14_FREQUENCY, QMetaType::Int);
    addField(S3B_Q15_FREQUENCY, QMetaType::Int);
    addField(S3B_Q16_FREQUENCY, QMetaType::Int);
    addField(S3B_Q17_FREQUENCY, QMetaType::Int);
    addField(S3B_AGE_BEGAN, QMetaType::Double);
    addField(S3B_EXTRA, QMetaType::QString);
    addField(S3C_Q1, QMetaType::Int);
    addField(S3C_Q2, QMetaType::Int);
    addField(S3C_Q3, QMetaType::Int);
    addField(S3C_Q4, QMetaType::Int);
    addField(S3C_Q5, QMetaType::Int);
    addField(S3C_Q6, QMetaType::Int);
    addField(S3C_Q7, QMetaType::Int);
    addField(S3C_Q8, QMetaType::Int);
    addField(S3C_Q9, QMetaType::Int);
    addField(S3C_Q10, QMetaType::Int);
    addField(S3C_Q11, QMetaType::Int);
    addField(S3C_Q12, QMetaType::Int);
    addField(S3C_Q13, QMetaType::Int);
    addField(S3C_Q14, QMetaType::Int);
    addField(S3C_Q15, QMetaType::Int);
    addField(S3C_Q16, QMetaType::Int);
    addField(S3C_Q17, QMetaType::Int);
    addField(S3C_WHICH_PARENT_CARED_FOR, QMetaType::Int);
    addField(S3C_PARENT_MENTAL_PROBLEM, QMetaType::Int);
    addField(S3C_PARENT_PHYSICAL_PROBLEM, QMetaType::Int);
    addField(S4A_ADULTCONFIDANT, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_MOTHER, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_FATHER, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_OTHERRELATIVE, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_FAMILYFRIEND, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_RESPONSIBLEADULT, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_OTHER, QMetaType::Bool);
    addField(S4A_ADULTCONFIDANT_OTHER_DETAIL, QMetaType::QString);
    addField(S4A_ADULTCONFIDANT_ADDITIONAL, QMetaType::QString);
    addField(S4B_CHILDCONFIDANT, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_SISTER, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_BROTHER, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_OTHERRELATIVE, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_CLOSEFRIEND, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_OTHERFRIEND, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_OTHER, QMetaType::Bool);
    addField(S4B_CHILDCONFIDANT_OTHER_DETAIL, QMetaType::QString);
    addField(S4B_CHILDCONFIDANT_ADDITIONAL, QMetaType::QString);
    addField(S4C_CLOSEST_MOTHER, QMetaType::Bool);
    addField(S4C_CLOSEST_FATHER, QMetaType::Bool);
    addField(S4C_CLOSEST_SIBLING, QMetaType::Bool);
    addField(S4C_CLOSEST_OTHERRELATIVE, QMetaType::Bool);
    addField(S4C_CLOSEST_ADULTFRIEND, QMetaType::Bool);
    addField(S4C_CLOSEST_CHILDFRIEND, QMetaType::Bool);
    addField(S4C_CLOSEST_OTHER, QMetaType::Bool);
    addField(S4C_CLOSEST_OTHER_DETAIL, QMetaType::QString);
    addField(S4C_CLOSEST_ADDITIONAL, QMetaType::QString);
    addField(S5C_PHYSICALABUSE, QMetaType::Bool);
    addField(S5C_ABUSED_BY_MOTHER, QMetaType::Bool); // RNC extra
    addField(S5C_ABUSED_BY_FATHER, QMetaType::Bool); // RNC extra
    addField(S5C_MOTHER_ABUSE_AGE_BEGAN, QMetaType::Double);
    addField(S5C_FATHER_ABUSE_AGE_BEGAN, QMetaType::Double);
    addField(S5C_MOTHER_HIT_MORE_THAN_ONCE, QMetaType::Bool);
    addField(S5C_FATHER_HIT_MORE_THAN_ONCE, QMetaType::Bool);
    addField(S5C_MOTHER_HIT_HOW, QMetaType::Int);
    addField(S5C_FATHER_HIT_HOW, QMetaType::Int);
    addField(S5C_MOTHER_INJURED, QMetaType::Bool);
    addField(S5C_FATHER_INJURED, QMetaType::Bool);
    addField(S5C_MOTHER_OUT_OF_CONTROL, QMetaType::Bool);
    addField(S5C_FATHER_OUT_OF_CONTROL, QMetaType::Bool);
    addField(S5C_PARENTAL_ABUSE_DESCRIPTION, QMetaType::QString);
    addField(S5C_ABUSE_BY_NONPARENT, QMetaType::Bool);
    addField(S5C_NONPARENT_ABUSE_DESCRIPTION, QMetaType::QString);
    addField(S6_ANY_UNWANTED_SEXUAL_EXPERIENCE, QMetaType::Int);  // not bool
    addField(S6_UNWANTED_INTERCOURSE, QMetaType::Int);  // not bool
    addField(S6_UPSETTING_SEXUAL_ADULT_AUTHORITY, QMetaType::Int);  // not bool
    addField(S6_FIRST_AGE, QMetaType::Double);
    addField(S6_OTHER_AGE, QMetaType::Double);
    addField(S6_FIRST_PERSON_KNOWN, QMetaType::Bool);
    addField(S6_OTHER_PERSON_KNOWN, QMetaType::Bool);
    addField(S6_FIRST_RELATIVE, QMetaType::Bool);
    addField(S6_OTHER_RELATIVE, QMetaType::Bool);
    addField(S6_FIRST_IN_HOUSEHOLD, QMetaType::Bool);
    addField(S6_OTHER_IN_HOUSEHOLD, QMetaType::Bool);
    addField(S6_FIRST_MORE_THAN_ONCE, QMetaType::Bool);
    addField(S6_OTHER_MORE_THAN_ONCE, QMetaType::Bool);
    addField(S6_FIRST_TOUCH_PRIVATES_SUBJECT, QMetaType::Bool);
    addField(S6_OTHER_TOUCH_PRIVATES_SUBJECT, QMetaType::Bool);
    addField(S6_FIRST_TOUCH_PRIVATES_OTHER, QMetaType::Bool);
    addField(S6_OTHER_TOUCH_PRIVATES_OTHER, QMetaType::Bool);
    addField(S6_FIRST_INTERCOURSE, QMetaType::Bool);
    addField(S6_OTHER_INTERCOURSE, QMetaType::Bool);
    addField(S6_UNWANTED_SEXUAL_DESCRIPTION, QMetaType::QString);
    addField(ANY_OTHER_COMMENTS, QMetaType::QString);
