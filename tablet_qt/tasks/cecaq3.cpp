...
const QString S1A_FATHERFIGURE_MALERELATIVE_DETAIL(
...
const QString S1C_FIRST_SEPARATED_FROM_MOTHER_AGED(
    "s1c_first_separated_from_mother_aged"
);
const QString S1C_FIRST_SEPARATED_FROM_FATHER_AGED(
...
const QString S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL(
...
const QString S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL(
