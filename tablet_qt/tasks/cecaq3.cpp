...
const QString S1A_MOTHERFIGURE_FEMALERELATIVE_DETAIL(
...
const QString
    S1A_FATHERFIGURE_MALERELATIVE_DETAIL("s1a_fatherfigure_malerelative_detail"
    );
...
const QString
    S1C_FIRST_SEPARATED_FROM_MOTHER_AGED("s1c_first_separated_from_mother_aged"
    );
const QString
    S1C_FIRST_SEPARATED_FROM_FATHER_AGED("s1c_first_separated_from_father_aged"
    );
const QString S1C_MOTHER_HOW_LONG_FIRST_SEPARATION_YEARS(
    "s1c_mother_how_long_first_separation_years"
);
const QString S1C_FATHER_HOW_LONG_FIRST_SEPARATION_YEARS(
...
const QString
    S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL("s2a_which_mother_figure_other_detail"
    );
...
const QString
    S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL("s3a_which_father_figure_other_detail"
    );
...
const QString
    S4A_ADULTCONFIDANT_OTHERRELATIVE("s4a_adultconfidant_otherrelative");
const QString S4A_ADULTCONFIDANT_FAMILYFRIEND("s4a_adultconfidant_familyfriend"
);
const QString
    S4A_ADULTCONFIDANT_RESPONSIBLEADULT("s4a_adultconfidant_responsibleadult");
...
const QString
    S4B_CHILDCONFIDANT_OTHERRELATIVE("s4b_childconfidant_otherrelative");
...
const QString
    S6_ANY_UNWANTED_SEXUAL_EXPERIENCE("s6_any_unwanted_sexual_experience");
const QString S6_UNWANTED_INTERCOURSE("s6_unwanted_intercourse");
const QString
    S6_UPSETTING_SEXUAL_ADULT_AUTHORITY("s6_upsetting_sexual_adult_authority");
...
CecaQ3::CecaQ3(CamcopsApp& app, DatabaseManager& db, const int load_pk) :
    Task(
        app, db, CECAQ3_TABLENAME, false, false, false
    ),  // ... anon, clin, resp
    m_questionnaire(nullptr)
{
    addField(S1A_MOTHERFIGURE_BIRTHMOTHER, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_STEPMOTHER, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_FEMALERELATIVE, QMetaType::fromType<bool>());
    addField(
        S1A_MOTHERFIGURE_FEMALERELATIVE_DETAIL, QMetaType::fromType<QString>()
    );
    addField(S1A_MOTHERFIGURE_FAMILYFRIEND, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_FOSTERMOTHER, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_ADOPTIVEMOTHER, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_OTHER, QMetaType::fromType<bool>());
    addField(S1A_MOTHERFIGURE_OTHER_DETAIL, QMetaType::fromType<QString>());
    addField(S1A_FATHERFIGURE_BIRTHFATHER, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_STEPFATHER, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_MALERELATIVE, QMetaType::fromType<bool>());
    addField(
        S1A_FATHERFIGURE_MALERELATIVE_DETAIL, QMetaType::fromType<QString>()
    );
    addField(S1A_FATHERFIGURE_FAMILYFRIEND, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_FOSTERFATHER, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_ADOPTIVEFATHER, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_OTHER, QMetaType::fromType<bool>());
    addField(S1A_FATHERFIGURE_OTHER_DETAIL, QMetaType::fromType<QString>());
    addField(S1B_INSTITUTION, QMetaType::fromType<bool>());
    addField(S1B_INSTITUTION_TIME_YEARS, QMetaType::fromType<double>());
    addField(S1C_MOTHER_DIED, QMetaType::fromType<bool>());
    addField(S1C_FATHER_DIED, QMetaType::fromType<bool>());
    addField(S1C_MOTHER_DIED_SUBJECT_AGED, QMetaType::fromType<double>());
    addField(S1C_FATHER_DIED_SUBJECT_AGED, QMetaType::fromType<double>());
    addField(S1C_SEPARATED_FROM_MOTHER, QMetaType::fromType<bool>());
    addField(S1C_SEPARATED_FROM_FATHER, QMetaType::fromType<bool>());
    addField(
        S1C_FIRST_SEPARATED_FROM_MOTHER_AGED, QMetaType::fromType<double>()
    );
    addField(
        S1C_FIRST_SEPARATED_FROM_FATHER_AGED, QMetaType::fromType<double>()
    );
    addField(
        S1C_MOTHER_HOW_LONG_FIRST_SEPARATION_YEARS,
    ...
    addField(S1C_MOTHER_SEPARATION_REASON, QMetaType::fromType<int>());
    addField(S1C_FATHER_SEPARATION_REASON, QMetaType::fromType<int>());
    addField(S1C_DESCRIBE_EXPERIENCE, QMetaType::fromType<QString>());
    addField(S2A_WHICH_MOTHER_FIGURE, QMetaType::fromType<int>());
    addField(
        S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL, QMetaType::fromType<QString>()
    );
    addField(S2A_Q1, QMetaType::fromType<int>());
    addField(S2A_Q2, QMetaType::fromType<int>());
    addField(S2A_Q3, QMetaType::fromType<int>());
    addField(S2A_Q4, QMetaType::fromType<int>());
    addField(S2A_Q5, QMetaType::fromType<int>());
    addField(S2A_Q6, QMetaType::fromType<int>());
    addField(S2A_Q7, QMetaType::fromType<int>());
    addField(S2A_Q8, QMetaType::fromType<int>());
    addField(S2A_Q9, QMetaType::fromType<int>());
    addField(S2A_Q10, QMetaType::fromType<int>());
    addField(S2A_Q11, QMetaType::fromType<int>());
    addField(S2A_Q12, QMetaType::fromType<int>());
    addField(S2A_Q13, QMetaType::fromType<int>());
    addField(S2A_Q14, QMetaType::fromType<int>());
    addField(S2A_Q15, QMetaType::fromType<int>());
    addField(S2A_Q16, QMetaType::fromType<int>());
    addField(S2A_EXTRA, QMetaType::fromType<QString>());
    addField(S2B_Q1, QMetaType::fromType<int>());
    addField(S2B_Q2, QMetaType::fromType<int>());
    addField(S2B_Q3, QMetaType::fromType<int>());
    addField(S2B_Q4, QMetaType::fromType<int>());
    addField(S2B_Q5, QMetaType::fromType<int>());
    addField(S2B_Q6, QMetaType::fromType<int>());
    addField(S2B_Q7, QMetaType::fromType<int>());
    addField(S2B_Q8, QMetaType::fromType<int>());
    addField(S2B_Q9, QMetaType::fromType<int>());
    addField(S2B_Q10, QMetaType::fromType<int>());
    addField(S2B_Q11, QMetaType::fromType<int>());
    addField(S2B_Q12, QMetaType::fromType<int>());
    addField(S2B_Q13, QMetaType::fromType<int>());
    addField(S2B_Q14, QMetaType::fromType<int>());
    addField(S2B_Q15, QMetaType::fromType<int>());
    addField(S2B_Q16, QMetaType::fromType<int>());
    addField(S2B_Q17, QMetaType::fromType<int>());
    addField(S2B_Q1_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q2_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q3_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q4_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q5_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q6_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q7_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q8_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q9_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q10_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q11_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q12_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q13_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q14_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q15_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q16_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_Q17_FREQUENCY, QMetaType::fromType<int>());
    addField(S2B_AGE_BEGAN, QMetaType::fromType<double>());
    addField(S2B_EXTRA, QMetaType::fromType<QString>());
    addField(S3A_WHICH_FATHER_FIGURE, QMetaType::fromType<int>());
    addField(
        S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL, QMetaType::fromType<QString>()
    );
    addField(S3A_Q1, QMetaType::fromType<int>());
    addField(S3A_Q2, QMetaType::fromType<int>());
    addField(S3A_Q3, QMetaType::fromType<int>());
    addField(S3A_Q4, QMetaType::fromType<int>());
    addField(S3A_Q5, QMetaType::fromType<int>());
    addField(S3A_Q6, QMetaType::fromType<int>());
    addField(S3A_Q7, QMetaType::fromType<int>());
    addField(S3A_Q8, QMetaType::fromType<int>());
    addField(S3A_Q9, QMetaType::fromType<int>());
    addField(S3A_Q10, QMetaType::fromType<int>());
    addField(S3A_Q11, QMetaType::fromType<int>());
    addField(S3A_Q12, QMetaType::fromType<int>());
    addField(S3A_Q13, QMetaType::fromType<int>());
    addField(S3A_Q14, QMetaType::fromType<int>());
    addField(S3A_Q15, QMetaType::fromType<int>());
    addField(S3A_Q16, QMetaType::fromType<int>());
    addField(S3A_EXTRA, QMetaType::fromType<QString>());
    addField(S3B_Q1, QMetaType::fromType<int>());
    addField(S3B_Q2, QMetaType::fromType<int>());
    addField(S3B_Q3, QMetaType::fromType<int>());
    addField(S3B_Q4, QMetaType::fromType<int>());
    addField(S3B_Q5, QMetaType::fromType<int>());
    addField(S3B_Q6, QMetaType::fromType<int>());
    addField(S3B_Q7, QMetaType::fromType<int>());
    addField(S3B_Q8, QMetaType::fromType<int>());
    addField(S3B_Q9, QMetaType::fromType<int>());
    addField(S3B_Q10, QMetaType::fromType<int>());
    addField(S3B_Q11, QMetaType::fromType<int>());
    addField(S3B_Q12, QMetaType::fromType<int>());
    addField(S3B_Q13, QMetaType::fromType<int>());
    addField(S3B_Q14, QMetaType::fromType<int>());
    addField(S3B_Q15, QMetaType::fromType<int>());
    addField(S3B_Q16, QMetaType::fromType<int>());
    addField(S3B_Q17, QMetaType::fromType<int>());
    addField(S3B_Q1_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q2_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q3_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q4_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q5_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q6_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q7_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q8_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q9_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q10_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q11_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q12_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q13_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q14_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q15_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q16_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_Q17_FREQUENCY, QMetaType::fromType<int>());
    addField(S3B_AGE_BEGAN, QMetaType::fromType<double>());
    addField(S3B_EXTRA, QMetaType::fromType<QString>());
    addField(S3C_Q1, QMetaType::fromType<int>());
    addField(S3C_Q2, QMetaType::fromType<int>());
    addField(S3C_Q3, QMetaType::fromType<int>());
    addField(S3C_Q4, QMetaType::fromType<int>());
    addField(S3C_Q5, QMetaType::fromType<int>());
    addField(S3C_Q6, QMetaType::fromType<int>());
    addField(S3C_Q7, QMetaType::fromType<int>());
    addField(S3C_Q8, QMetaType::fromType<int>());
    addField(S3C_Q9, QMetaType::fromType<int>());
    addField(S3C_Q10, QMetaType::fromType<int>());
    addField(S3C_Q11, QMetaType::fromType<int>());
    addField(S3C_Q12, QMetaType::fromType<int>());
    addField(S3C_Q13, QMetaType::fromType<int>());
    addField(S3C_Q14, QMetaType::fromType<int>());
    addField(S3C_Q15, QMetaType::fromType<int>());
    addField(S3C_Q16, QMetaType::fromType<int>());
    addField(S3C_Q17, QMetaType::fromType<int>());
    addField(S3C_WHICH_PARENT_CARED_FOR, QMetaType::fromType<int>());
    addField(S3C_PARENT_MENTAL_PROBLEM, QMetaType::fromType<int>());
    addField(S3C_PARENT_PHYSICAL_PROBLEM, QMetaType::fromType<int>());
    addField(S4A_ADULTCONFIDANT, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_MOTHER, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_FATHER, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_OTHERRELATIVE, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_FAMILYFRIEND, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_RESPONSIBLEADULT, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_OTHER, QMetaType::fromType<bool>());
    addField(S4A_ADULTCONFIDANT_OTHER_DETAIL, QMetaType::fromType<QString>());
    addField(S4A_ADULTCONFIDANT_ADDITIONAL, QMetaType::fromType<QString>());
    addField(S4B_CHILDCONFIDANT, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_SISTER, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_BROTHER, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_OTHERRELATIVE, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_CLOSEFRIEND, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_OTHERFRIEND, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_OTHER, QMetaType::fromType<bool>());
    addField(S4B_CHILDCONFIDANT_OTHER_DETAIL, QMetaType::fromType<QString>());
    addField(S4B_CHILDCONFIDANT_ADDITIONAL, QMetaType::fromType<QString>());
    addField(S4C_CLOSEST_MOTHER, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_FATHER, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_SIBLING, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_OTHERRELATIVE, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_ADULTFRIEND, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_CHILDFRIEND, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_OTHER, QMetaType::fromType<bool>());
    addField(S4C_CLOSEST_OTHER_DETAIL, QMetaType::fromType<QString>());
    addField(S4C_CLOSEST_ADDITIONAL, QMetaType::fromType<QString>());
    addField(S5C_PHYSICALABUSE, QMetaType::fromType<bool>());
    addField(S5C_ABUSED_BY_MOTHER, QMetaType::fromType<bool>());  // RNC extra
    addField(S5C_ABUSED_BY_FATHER, QMetaType::fromType<bool>());  // RNC extra
    addField(S5C_MOTHER_ABUSE_AGE_BEGAN, QMetaType::fromType<double>());
    addField(S5C_FATHER_ABUSE_AGE_BEGAN, QMetaType::fromType<double>());
    addField(S5C_MOTHER_HIT_MORE_THAN_ONCE, QMetaType::fromType<bool>());
    addField(S5C_FATHER_HIT_MORE_THAN_ONCE, QMetaType::fromType<bool>());
    addField(S5C_MOTHER_HIT_HOW, QMetaType::fromType<int>());
    addField(S5C_FATHER_HIT_HOW, QMetaType::fromType<int>());
    addField(S5C_MOTHER_INJURED, QMetaType::fromType<bool>());
    addField(S5C_FATHER_INJURED, QMetaType::fromType<bool>());
    addField(S5C_MOTHER_OUT_OF_CONTROL, QMetaType::fromType<bool>());
    addField(S5C_FATHER_OUT_OF_CONTROL, QMetaType::fromType<bool>());
    ...
    addField(
        S6_ANY_UNWANTED_SEXUAL_EXPERIENCE, QMetaType::fromType<int>()
    );  // not bool
    addField(S6_UNWANTED_INTERCOURSE, QMetaType::fromType<int>());  // not bool
    addField(
        S6_UPSETTING_SEXUAL_ADULT_AUTHORITY, QMetaType::fromType<int>()
    );  // not bool
    ...
    addField(S6_OTHER_PERSON_KNOWN, QMetaType::fromType<bool>());
    addField(S6_FIRST_RELATIVE, QMetaType::fromType<bool>());
    addField(S6_OTHER_RELATIVE, QMetaType::fromType<bool>());
    addField(S6_FIRST_IN_HOUSEHOLD, QMetaType::fromType<bool>());
    addField(S6_OTHER_IN_HOUSEHOLD, QMetaType::fromType<bool>());
    addField(S6_FIRST_MORE_THAN_ONCE, QMetaType::fromType<bool>());
    addField(S6_OTHER_MORE_THAN_ONCE, QMetaType::fromType<bool>());
    addField(S6_FIRST_TOUCH_PRIVATES_SUBJECT, QMetaType::fromType<bool>());
    addField(S6_OTHER_TOUCH_PRIVATES_SUBJECT, QMetaType::fromType<bool>());
    addField(S6_FIRST_TOUCH_PRIVATES_OTHER, QMetaType::fromType<bool>());
    addField(S6_OTHER_TOUCH_PRIVATES_OTHER, QMetaType::fromType<bool>());
    addField(S6_FIRST_INTERCOURSE, QMetaType::fromType<bool>());
    addField(S6_OTHER_INTERCOURSE, QMetaType::fromType<bool>());
    addField(S6_UNWANTED_SEXUAL_DESCRIPTION, QMetaType::fromType<QString>());
    addField(ANY_OTHER_COMMENTS, QMetaType::fromType<QString>());
...
{
    return tr(
        "Family relationships in childhood. Version 3 with "
...
{
    return complete1A() && complete1B() && complete1C() && complete2A()
        && complete2B() && complete3A() && complete3B() && complete3C()
        && complete4A() && complete4B() && complete4C() && complete5()
        && complete6();
}
...
OpenableWidget* CecaQ3::editor(const bool read_only)
{
    ...
    auto connectedfr = [this](
                           CallbackFn callback,
                           const QString& fieldname,
                           bool mandatory = false
                       ) -> FieldRefPtr {
        FieldRefPtr fr = fieldRef(fieldname, mandatory);
        connect(fr.data(), &FieldRef::valueChanged, this, callback);
        return fr;
    };
    ...
    auto textedit = [this, &connectedfr](
        ...
        QuTextEdit* e
            = new QuTextEdit(connectedfr(callback, fieldname, mandatory));
        if (hint.isEmpty()) {
            e->setHint("");
        } else {
    ...
    auto realedit = [this, &connectedfr](
        ...
        QuLineEditDouble* e
            = new QuLineEditDouble(connectedfr(callback, fieldname, mandatory)
            );
        if (!hint.isEmpty()) {
            e->setHint(xstring(hint));
        }
    ...
    auto yn = [&connectedfr, &options_yesno](
        ...
        return (new QuMcq(
                    connectedfr(callback, fieldname, mandatory), options_yesno
                ))
            ->setHorizontal(true);
    };
                 ...
                 2,
                 {
                     new QuVerticalContainer{
                         ...
                         (new QuMultipleResponse{
                             ...
                             ->setMinimumAnswers(1)
                             ->addTag(TAG_1A_PEOPLE),
                         text("rnc_1a_femalerelative_or_other"),
                         text("1a_mf_femalerelative"),
                         textedit(
                             cb1a, S1A_MOTHERFIGURE_FEMALERELATIVE_DETAIL
                         ),
                         text("other"),
    ...
    pages.append(QuPagePtr(
        (new QuPage{
             ...
             textedit(
                 cb2a, S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL, "hint_description"
             ),
             (new QuMcqGrid(
    ...
    pages.append(QuPagePtr(
        (new QuPage{
             ...
             text("rnc_if_other_describe"),
             textedit(
                 cb3a, S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL, "hint_description"
             ),
             (new QuMcqGrid(
                  QVector<QuestionWithOneField>{
...
bool CecaQ3::complete1B() const
{
    ...
    if (valueBool(S1B_INSTITUTION)
        && valueIsNull(S1B_INSTITUTION_TIME_YEARS)) {
        return false;
    }
    return true;
}
...
{
    int n = valueBool(S4C_CLOSEST_MOTHER) + valueBool(S4C_CLOSEST_FATHER)
        + valueBool(S4C_CLOSEST_SIBLING) + valueBool(S4C_CLOSEST_OTHERRELATIVE)
        + valueBool(S4C_CLOSEST_ADULTFRIEND)
        + valueBool(S4C_CLOSEST_CHILDFRIEND) + valueBool(S4C_CLOSEST_OTHER);
    if (n < 2) {
        return false;
    }
...
bool CecaQ3::complete5() const
{
    ...
    if (valueIsNull(S5C_ABUSED_BY_MOTHER) || valueIsNull(S5C_ABUSED_BY_FATHER)
...
void CecaQ3::dataChanged1A()
{
    ...
    // 2. Simpler things
    fieldRef(S1A_MOTHERFIGURE_FEMALERELATIVE_DETAIL)
        ->setMandatory(valueBool(S1A_MOTHERFIGURE_FEMALERELATIVE));
    fieldRef(S1A_MOTHERFIGURE_OTHER_DETAIL)
        ->setMandatory(valueBool(S1A_MOTHERFIGURE_OTHER));
    fieldRef(S1A_FATHERFIGURE_MALERELATIVE_DETAIL)
        ->setMandatory(valueBool(S1A_FATHERFIGURE_MALERELATIVE));
    fieldRef(S1A_FATHERFIGURE_OTHER_DETAIL)
        ->setMandatory(valueBool(S1A_FATHERFIGURE_OTHER));
}

void CecaQ3::dataChanged1B()
{
    fieldRef(S1B_INSTITUTION_TIME_YEARS)
        ->setMandatory(valueBool(S1B_INSTITUTION));
}

void CecaQ3::dataChanged1C()
{
    fieldRef(S1C_MOTHER_DIED_SUBJECT_AGED)
        ->setMandatory(valueBool(S1C_MOTHER_DIED));
    fieldRef(S1C_FATHER_DIED_SUBJECT_AGED)
        ->setMandatory(valueBool(S1C_FATHER_DIED));
    setMandatory(
        valueBool(S1C_SEPARATED_FROM_MOTHER),
        QStringList{
            S1C_FIRST_SEPARATED_FROM_MOTHER_AGED,
            S1C_MOTHER_HOW_LONG_FIRST_SEPARATION_YEARS,
            S1C_MOTHER_SEPARATION_REASON}
    ...
    setMandatory(
        valueBool(S1C_SEPARATED_FROM_FATHER),
        QStringList{
            S1C_FIRST_SEPARATED_FROM_FATHER_AGED,
            S1C_FATHER_HOW_LONG_FIRST_SEPARATION_YEARS,
            S1C_FATHER_SEPARATION_REASON}
...
{
    fieldRef(S2A_WHICH_MOTHER_FIGURE_OTHER_DETAIL)
        ->setMandatory(valueInt(S2A_WHICH_MOTHER_FIGURE) == 5);
...
void CecaQ3::dataChanged2B()
{
    ...
    for (int i = 1; i <= 17; ++i) {
        ...
        abuse = abuse || v;
        fieldRef(qstr + FS_FREQUENCY)
            ->setMandatory(v);  // not null and not zero
    }
...
{
    fieldRef(S3A_WHICH_FATHER_FIGURE_OTHER_DETAIL)
        ->setMandatory(valueInt(S3A_WHICH_FATHER_FIGURE) == 5);
...
void CecaQ3::dataChanged4A()
{
    ...
    // 2. Other
    fieldRef(S4A_ADULTCONFIDANT_OTHER_DETAIL)
        ->setMandatory(valueBool(S4A_ADULTCONFIDANT_OTHER));
}
...
void CecaQ3::dataChanged4B()
{
    ...
    // 2. Other
    fieldRef(S4B_CHILDCONFIDANT_OTHER_DETAIL)
        ->setMandatory(valueBool(S4B_CHILDCONFIDANT_OTHER));
}

void CecaQ3::dataChanged4C()
{
    fieldRef(S4C_CLOSEST_OTHER_DETAIL)
        ->setMandatory(valueBool(S4C_CLOSEST_OTHER));
}
...
void CecaQ3::setMandatory(const bool mandatory, const QStringList& fieldnames)
{
...
void CecaQ3::setMultipleResponseMinAnswers(
    const QString& tag, const int min_answers
)
{
    if (!m_questionnaire) {
        return;
    ...
    QVector<QuElement*> elements
        = m_questionnaire->getElementsByTag(tag, false);
    for (auto e : elements) {
