    ...
    Task(app, db, DEMOQUESTIONNAIRE_TABLENAME, true, false, false)
{
    ...
    addField(
        QStringLiteral("spinbox_real"), QMetaType::fromType<double>()
    );  // v2
    ...
    addField(
        QStringLiteral("photo_blobid"), QMetaType::fromType<int>()
    );  // FK to BLOB table
    // addField(QStringLiteral("photo_rotation"), QMetaType::fromType<QString>());  // DEFUNCT in v2
    addField(
        QStringLiteral("canvas_blobid"), QMetaType::fromType<int>()
    );  // FK to BLOB table
    addField(
        QStringLiteral("canvas2_blobid"), QMetaType::fromType<int>()
    );  // FK to BLOB table; v2
