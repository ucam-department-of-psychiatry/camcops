...
void HelpMenu::aboutQt()
{
    ...
    // style sheet means that QMessageBox will not display a native dialog.
    // This is the intended behaviour since Qt 6.5.5.
    // However, the non-native dialog looks a mess on iPad, resulting in a
    // blank dialog and no means to dismiss it.
