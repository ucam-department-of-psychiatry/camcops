...
public:
    ...
    TaskPtr create(const QString& key, int load_pk = dbconst::NONEXISTENT_PK)
        const;
    ...
    Version minimumServerVersion(const QString& tablename
    ) const;  // main or sub-table
...
protected:
    ...
    QVector<ProxyType>
        m_initial_proxy_list;  // holds proxies during initial registration
