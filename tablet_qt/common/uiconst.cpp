...
const QDate QCALENDARWIDGET_MAX_DATE
    = QDate();  // QCalendarWidget default ("no limit")
...
const QString
    CSS_CAMCOPS_DIAGNOSTIC_CODE(camcopsStylesheetFilename("diagnostic_code.css"
    ));
...
const QColor
    BUTTON_UNPRESSED_COLOUR(127, 127, 127, 100);  // translucent mid-grey
const QColor
    BUTTON_PRESSED_COLOUR(100, 100, 255, 200);  // translucent light blue
const QColor
    BUTTON_DISABLED_COLOUR(127, 127, 127, 200);  // very translucent mid-grey
...
const QString
    DEMO_SOUND_URL_1("qrc:///resources/camcops/sounds/bach_brandenburg_3_3.mp3"
    );
const QString
