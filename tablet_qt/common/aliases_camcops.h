...
using Khandaker2MojoTherapyItemPtr = QSharedPointer<KhandakerMojoTherapyItem>;

class KhandakerMojoMedicationItem;
using Khandaker2MojoMedicationItemPtr = QSharedPointer<KhandakerMojoMedicationItem>;
