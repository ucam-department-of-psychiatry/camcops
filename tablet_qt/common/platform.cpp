...
const QString COMPILER_NAME_VERSION
    = QString("GNU C++ compiler (GCC) version %1.%2.%3")
          .arg(
...
const QString COMPILER_NAME_VERSION = QString("Microsoft Visual C++ version %")
                                          .arg(QString::number(_MSC_FULL_VER));
#else
