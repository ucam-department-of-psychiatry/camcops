...
public:
    ...
    explicit Thermometer(
        ...
        = 1,  // arbitrary int representing "left text column proportion"
        int image_span
        = 1,  // arbitrary int representing "image column proportion"
        int right_string_span
        = 1,  // arbitrary int representing "right text column proportion"
        bool allow_deselection
        = true,  // allow images to be re-clicked to deselect them?
...
protected:
    // Config:
    QVector<QPixmap>
        m_active_images;  // all active (selected) images, top to bottom
    QVector<QPixmap>
        m_inactive_images;  // all inactive (unselected) images, top to bottom
    ...
    QVector<QPixmap>
        m_active_touched_images;  // "selected and being touched" images
    QVector<QPixmap>
        m_inactive_touched_images;  // "unselected and being touched" images
};
