...
protected:
    ...
    QVector<PenBrush>
        m_cursor_active_penbrushes;  // "active" cursor colours; length n - 1
    ...
    qreal
        m_cursor_angle_degrees;  // sector angle of the cursors (visual style)
    ...
    qreal
        m_base_compass_heading_deg;  // pie orientation; see setBaseCompassHeading()
    ...
    QVector<qreal>
        m_cursor_props_cum;  // cumulative proportions for each cursor; length n - 1
