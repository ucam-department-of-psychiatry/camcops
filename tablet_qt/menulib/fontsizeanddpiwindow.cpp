...
void FontSizeAndDpiWindow::setUpPage(QuPagePtr page)
{
    ...
    const double dpi_min
        = 50;  // 67 realistic low end; https://en.wikipedia.org/wiki/Pixel_density
    const double dpi_max
        = 4000;  // 3760 has been achieved; https://en.wikipedia.org/wiki/Pixel_density
