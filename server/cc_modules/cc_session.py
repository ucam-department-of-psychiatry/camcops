...
class Session:
    ...
    FIELDSPECS = [
        ...
        dict(name="filter_device", cctype="DEVICE",
             comment="Task filter in use: source device"),
        dict(name="filter_user", cctype="USERNAME",
             comment="Task filter in use: adding user"),
