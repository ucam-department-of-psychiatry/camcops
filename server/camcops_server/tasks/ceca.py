...
class CecaQ3(TaskHasPatientMixin, Task):
    ...
    def complete_1c(self) -> bool:
        ...
        if self.s1c_father_died and self.s1c_father_died_subject_aged is None:
            return False
        if (
            self.s1c_separated_from_mother is None
    ...
    def complete_5(self) -> bool:
        ...
        if self.s5c_physicalabuse == 0:
            return True
        if (
            self.s5c_abused_by_mother is None
    ...
    def total_nonzero_scores_1_abort_if_none(
    ...
    def parental_loss_risk(self) -> bool:
        return bool(
            ...
            or self.s1c_father_died
            or self.s1c_separated_from_mother
            or self.s1c_separated_from_father
        )
    ...
    def get_task_html(self, req: CamcopsRequest) -> str:
        ...
        html = (
            ...
            + tr_qa(
                "Parental loss risk factor? <sup>[1]</sup>",
                get_yes_no(req, self.parental_loss_risk()),
            )
            + tr_qa(
                "Parental loss higher risk factor? <sup>[2]</sup>",
                get_yes_no(req, self.parental_loss_high_risk()),
            )
            + tr_qa(
                "Maternal antipathy score (8–40) <sup>[3]</sup>",
                self.mother_antipathy(),
            )
            + tr_qa(
                "Maternal neglect score (8–40) <sup>[3]</sup>",
                self.mother_neglect(),
            )
            + tr_qa(
                "Maternal psychological abuse score (0–85) <sup>[4]</sup>",
                self.mother_psychological_abuse(),
            )
            + tr_qa(
                "Paternal antipathy score (8–40) <sup>[3]</sup>",
                self.father_antipathy(),
            )
            + tr_qa(
                "Paternal neglect score (8–40) <sup>[3]</sup>",
                self.father_neglect(),
            )
            + tr_qa(
                "Paternal psychological abuse score (0–85) <sup>[4]</sup>",
                self.father_psychological_abuse(),
            )
            + tr_qa(
                "Role reversal score (17–85) <sup>[5]</sup>",
                self.role_reversal(),
            )
            + tr_qa(
                "Physical abuse screen (0–1) <sup>[6]</sup>",
                self.physical_abuse_screen(),
            )
            + tr_qa(
                "Maternal physical abuse severity score (0–4) "
                "<sup>[6]</sup>",
                self.physical_abuse_severity_mother(),
            )
            + tr_qa(
                "Paternal physical abuse severity score (0–4) "
                "<sup>[6]</sup>",
            ...
            + tr_qa(
                "First sexual abuse severity score (0–7) <sup>[7]</sup>",
                self.sexual_abuse_score_first(),
            )
            + tr_qa(
                "Other sexual abuse severity score (0–7) <sup>[7]</sup>",
            ...
            """
            + subheading_spanning_two_columns("1A: " + wxstring("1a_q"))
            + subsubheading_from_wstring("1a_motherfigures")
            + wstring_boolean(
                "1a_mf_birthmother", self.s1a_motherfigure_birthmother
            )
            + wstring_boolean(
                "1a_mf_stepmother", self.s1a_motherfigure_stepmother
            )
            + wstring_boolean(
                "1a_mf_femalerelative", self.s1a_motherfigure_femalerelative
            )
            + string_string(
                "(Female relative details)",
                self.s1a_motherfigure_femalerelative_detail,
            )
            + wstring_boolean(
                "1a_mf_familyfriend", self.s1a_motherfigure_familyfriend
            )
            + wstring_boolean(
                "1a_mf_fostermother", self.s1a_motherfigure_fostermother
            )
            + wstring_boolean(
                "1a_mf_adoptivemother", self.s1a_motherfigure_adoptivemother
            )
            + wstring_boolean("other", self.s1a_motherfigure_other)
            + string_string(
                "(Other, details)", self.s1a_motherfigure_other_detail
            )
            + subsubheading_from_wstring("1a_fatherfigures")
            + wstring_boolean(
                "1a_ff_birthfather", self.s1a_fatherfigure_birthfather
            )
            + wstring_boolean(
                "1a_ff_stepfather", self.s1a_fatherfigure_stepfather
            )
            + wstring_boolean(
                "1a_ff_malerelative", self.s1a_fatherfigure_malerelative
            )
            + string_string(
                "(Male relative details)",
                self.s1a_fatherfigure_malerelative_detail,
            )
            + wstring_boolean(
                "1a_ff_familyfriend", self.s1a_fatherfigure_familyfriend
            )
            + wstring_boolean(
                "1a_ff_fosterfather", self.s1a_fatherfigure_fosterfather
            )
            + wstring_boolean(
                "1a_ff_adoptivefather", self.s1a_fatherfigure_adoptivefather
            )
            + wstring_boolean("other", self.s1a_fatherfigure_other)
            + string_string(
                "(Other, details)", self.s1a_fatherfigure_other_detail
            )
            ...
            + string_boolean("Mother died before age 17", self.s1c_mother_died)
            + wstring_numeric(
                "1c_parentdiedage", self.s1c_mother_died_subject_aged
            )
            + string_boolean(
                "Separated from mother for >1y", self.s1c_separated_from_mother
            )
            + wstring_numeric(
                "1c_age_first_separated",
            ...
            + wstring_numeric(
                "1c_parentdiedage", self.s1c_father_died_subject_aged
            )
            + string_boolean(
                "Separated from father for >1y", self.s1c_separated_from_father
            )
            + wstring_numeric(
                "1c_age_first_separated",
            ...
            + wstring_string(
                "please_describe_experience", self.s1c_describe_experience
            )
            + subheading_from_string("2A: " + wxstring("2a_heading"))
            + wstring_dict(
                "2a_which", self.s2a_which_mother_figure, motherfigure_map
            )
            + wstring_string(
                "rnc_if_other_describe",
                self.s2a_which_mother_figure_other_detail,
            )
        )
        for i in range(1, 17):
            html += string_dict(
                str(i) + ". " + wxstring("2a_q" + str(i)),
                getattr(self, "s2a_q" + str(i)),
                no_yes_5way_map,
            )
        html += wstring_string(
            "2a_add_anything", self.s2a_extra
        ...
        for i in range(1, 18):
            html += tr(
                ...
                answer(
                    get_from_dict(
                        no_yes_3way_map, getattr(self, "s2b_q" + str(i))
                    )
                )
                + " ("
                + answer(
        ...
        html += (
            ...
            + wstring_dict(
                "2a_which", self.s3a_which_father_figure, fatherfigure_map
            )
            + wstring_string(
                "rnc_if_other_describe",
        ...
        for i in range(1, 17):
            html += string_dict(
                ...
                getattr(self, "s3a_q" + str(i)),
                no_yes_5way_map,
            )
        html += wstring_string(
            "3a_add_anything", self.s3a_extra
        ...
        for i in range(1, 18):
            html += tr(
                ...
                answer(
                    get_from_dict(
                        no_yes_3way_map, getattr(self, "s3b_q" + str(i))
                    )
                )
                + " ("
                + answer(
        ...
        for i in range(1, 18):
            html += string_dict(
                ...
                getattr(self, "s3c_q" + str(i)),
                no_yes_5way_map,
            )
        html += (
            wstring_dict(
                "3c_which_parent_cared_for",
                self.s3c_which_parent_cared_for,
                parent_cared_for_map,
            )
            + wstring_boolean(
                "3c_parent_mental_problem", self.s3c_parent_mental_problem
            )
            + wstring_boolean(
                "3c_parent_physical_problem", self.s3c_parent_physical_problem
            )
            ...
            + wstring_boolean(
                "4a_option_mother", self.s4a_adultconfidant_mother
            )
            + wstring_boolean(
                "4a_option_father", self.s4a_adultconfidant_father
            )
            + wstring_boolean(
                "4a_option_relative", self.s4a_adultconfidant_otherrelative
            )
            + wstring_boolean(
                "4a_option_friend", self.s4a_adultconfidant_familyfriend
            )
            + wstring_boolean(
                "4a_option_responsibleadult",
                self.s4a_adultconfidant_responsibleadult,
            )
            + wstring_boolean("4a_option_other", self.s4a_adultconfidant_other)
            + string_string(
                "(Other, details)", self.s4a_adultconfidant_other_detail
            )
            + wstring_string(
                "4_note_anything", self.s4a_adultconfidant_additional
            )
            + subsubheading_from_string("(Child confidant)")
            + wstring_boolean("4b_q", self.s4b_childconfidant)
            + subsubheading_from_wstring("4_if_so_who")
            + wstring_boolean(
                "4b_option_sister", self.s4b_childconfidant_sister
            )
            + wstring_boolean(
                "4b_option_brother", self.s4b_childconfidant_brother
            )
            + wstring_boolean(
                "4b_option_relative", self.s4b_childconfidant_otherrelative
            )
            + wstring_boolean(
                "4b_option_closefriend", self.s4b_childconfidant_closefriend
            )
            + wstring_boolean(
                "4b_option_otherfriend", self.s4b_childconfidant_otherfriend
            )
            + wstring_boolean("4b_option_other", self.s4b_childconfidant_other)
            + string_string(
                "(Other, details)", self.s4b_childconfidant_other_detail
            )
            + wstring_string(
                "4_note_anything", self.s4b_childconfidant_additional
            )
            + subsubheading_from_wstring("4c_q")
            + wstring_boolean("4c_option_mother", self.s4c_closest_mother)
            + wstring_boolean("4c_option_father", self.s4c_closest_father)
            + string_boolean("4c_option_sibling", self.s4c_closest_sibling)
            + wstring_boolean(
                "4c_option_relative", self.s4c_closest_otherrelative
            )
            + wstring_boolean(
                "4c_option_adultfriend", self.s4c_closest_adultfriend
            )
            + wstring_boolean(
                "4c_option_youngfriend", self.s4c_closest_childfriend
            )
            ...
            + wstring_boolean(
                "5_did_this_person_hurt_you", self.s5c_abused_by_mother
            )
            + wstring_numeric("5_how_old", self.s5c_mother_abuse_age_began)
            + wstring_boolean(
                "5_hit_more_than_once", self.s5c_mother_hit_more_than_once
            )
            ...
            + wstring_boolean(
                "5_did_this_person_hurt_you", self.s5c_abused_by_father
            )
            + wstring_numeric("5_how_old", self.s5c_father_abuse_age_began)
            + wstring_boolean(
                "5_hit_more_than_once", self.s5c_father_hit_more_than_once
            )
            ...
            + wstring_string(
                "5_can_you_describe_1", self.s5c_parental_abuse_description
            )
            + subsubheading_from_string("(Other in household)")
            + wstring_boolean("5_anyone_else", self.s5c_abuse_by_nonparent)
            + wstring_string(
                "5_can_you_describe_2", self.s5c_nonparent_abuse_description
            )
            ...
            + wstring_dict(
                "6_intercourse", self.s6_unwanted_intercourse, no_yes_3way_map
            )
            + wstring_dict(
                "6_upset_adult_authority",
            ...
            + wstring_string(
                "5_can_you_describe_1", self.s6_unwanted_sexual_description
            )
