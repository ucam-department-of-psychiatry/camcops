...
class Pcl5(  # type: ignore[misc]
    ...
    def get_clinical_text(self, req: CamcopsRequest) -> List[CtvInfo]:
        ...
        return [CtvInfo(content=f"PCL-5 total score {self.total_score()}")]
    ...
    def ptsd(self) -> bool:
        ...
        return (
            num_symptomatic_b >= 1
            and num_symptomatic_c >= 1
            and num_symptomatic_d >= 2
            and num_symptomatic_e >= 2
        )
    ...
    def get_task_html(self, req: CamcopsRequest) -> str:
        ...
        h = """
            ...
            <table class="{CssClass.TASKDETAIL}">
                <tr>
                    <colgroup>
                        <col class="pcl5-question-col" />
                        <col class="pcl5-answer-col" />
                    </colgroup>
                    <th>Question</th>
                    <th>Answer</th>
                </tr>
