...
class Aq10Tests(TestCase):
    ...
    def test_max_score_is_10(self) -> None:
        ...
        for q_num in self.AGREE_SCORING_QUESTIONS:
            setattr(aq10, f"q{q_num}", self.DEFINITELY_AGREE)

        for q_num in self.DISAGREE_SCORING_QUESTIONS:
            setattr(aq10, f"q{q_num}", self.DEFINITELY_DISAGREE)

        self.assertEqual(aq10.score(), 10)
    ...
    def test_score_is_none_if_any_none(self) -> None:
        ...
        aq10.q1 = None  # type: ignore[attr-defined]

        self.assertIsNone(aq10.score())

    def test_incomplete_when_answers_missing(self) -> None:
        aq10 = Aq10()

        self.assertFalse(aq10.is_complete())
    ...
    def test_complete_when_all_answered(self) -> None:
        ...
        self.assertTrue(aq10.is_complete())
