...
"""
camcops_server/alembic/versions/0032_esspri.py
...
Revision ID: 0032
Revises: 0031
Creation date: 2019-07-09 15:45:34.291900
...
def upgrade():
    ...
    op.create_table('esspri',
        sa.Column('q1', sa.Integer(), nullable=True, comment='Q1 (dryness) (0 none - 10 maximum imaginable)'),
        sa.Column('q2', sa.Integer(), nullable=True, comment='Q2 (fatigue) (0 none - 10 maximum imaginable)'),
        sa.Column('q3', sa.Integer(), nullable=True, comment='Q3 (pain) (0 none - 10 maximum imaginable)'),
        ...
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_esspri__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_esspri__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_esspri__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_esspri__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_esspri__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_esspri__removing_user_id')),
        sa.PrimaryKeyConstraint('_pk', name=op.f('pk_esspri')),
        mysql_charset='utf8mb4 COLLATE utf8mb4_unicode_ci',
        mysql_engine='InnoDB',
        mysql_row_format='DYNAMIC'
    )
    with op.batch_alter_table('esspri', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_esspri__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_esspri_when_last_modified'), ['when_last_modified'], unique=False)


# noinspection PyPep8,PyTypeChecker
def downgrade():
    op.drop_table('esspri')
