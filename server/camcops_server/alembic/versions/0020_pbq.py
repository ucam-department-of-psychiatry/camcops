...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q1, I feel close to my baby (always 0 - never 5, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q2, I wish the old days when I had no baby would come back"
                " (always 5 - never 0, higher worse)"
            ),
        ),
        sa.Column(
            "q3",
            ...
            nullable=True,
            comment=(
                "Q3, I feel distant from my baby (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q4, I love to cuddle my baby (always 0 - never 5, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q5, I regret having this baby (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q6, The baby does not seem to be mine (always 5 - never 0,"
                " higher worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q7, My baby winds me up (always 5 - never 0, higher worse)"
            ),
        ),
        sa.Column(
            "q8",
            ...
            nullable=True,
            comment=(
                "Q8, I love my baby to bits (always 0 - never 5, higher worse)"
            ),
        ),
        sa.Column(
            "q9",
            ...
            nullable=True,
            comment=(
                "Q9, I feel happy when my baby smiles or laughs (always 0 -"
                " never 5, higher worse)"
            ),
        ),
        sa.Column(
            "q10",
            ...
            nullable=True,
            comment=(
                "Q10, My baby irritates me (always 5 - never 0, higher worse)"
            ),
        ),
        sa.Column(
            "q11",
            ...
            nullable=True,
            comment=(
                "Q11, I enjoy playing with my baby (always 0 - never 5, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q12, My baby cries too much (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q13, I feel trapped as a mother (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q14, I feel angry with my baby (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q16, My baby is the most beautiful baby in the world (always"
                " 0 - never 5, higher worse)"
            ),
        ),
        sa.Column(
            "q17",
            ...
            nullable=True,
            comment=(
                "Q17, I wish my baby would somehow go away (always 5 - never"
                " 0, higher worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q18, I have done harmful things to my baby (always 5 - never"
                " 0, higher worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q19, My baby makes me anxious (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q20, I am afraid of my baby (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q21, My baby annoys me (always 5 - never 0, higher worse)"
            ),
        ),
        sa.Column(
            "q22",
            ...
            nullable=True,
            comment=(
                "Q22, I feel confident when changing my baby (always 0 - never"
                " 5, higher worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q23, I feel the only solution is for someone else to look"
                " after my baby (always 5 - never 0, higher worse)"
            ),
        ),
        sa.Column(
            "q24",
            ...
            nullable=True,
            comment=(
                "Q24, I feel like hurting my baby (always 5 - never 0, higher"
                " worse)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q25, My baby is easily comforted (always 0 - never 5, higher"
                " worse)"
            ),
        ),
        sa.Column(
