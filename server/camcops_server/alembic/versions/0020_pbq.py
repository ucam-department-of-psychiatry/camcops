...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Q1, I feel close to my baby (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q2",
            sa.Integer(),
            nullable=True,
            comment="Q2, I wish the old days when I had no baby would come back (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q3",
            sa.Integer(),
            nullable=True,
            comment="Q3, I feel distant from my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q4",
            sa.Integer(),
            nullable=True,
            comment="Q4, I love to cuddle my baby (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q5",
            sa.Integer(),
            nullable=True,
            comment="Q5, I regret having this baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q6",
            sa.Integer(),
            nullable=True,
            comment="Q6, The baby does not seem to be mine (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q7",
            sa.Integer(),
            nullable=True,
            comment="Q7, My baby winds me up (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q8",
            sa.Integer(),
            nullable=True,
            comment="Q8, I love my baby to bits (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q9",
            sa.Integer(),
            nullable=True,
            comment="Q9, I feel happy when my baby smiles or laughs (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q10",
            sa.Integer(),
            nullable=True,
            comment="Q10, My baby irritates me (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q11",
            sa.Integer(),
            nullable=True,
            comment="Q11, I enjoy playing with my baby (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q12",
            sa.Integer(),
            nullable=True,
            comment="Q12, My baby cries too much (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q13",
            sa.Integer(),
            nullable=True,
            comment="Q13, I feel trapped as a mother (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q14",
            sa.Integer(),
            nullable=True,
            comment="Q14, I feel angry with my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q15",
            sa.Integer(),
            nullable=True,
            comment="Q15, I resent my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q16",
            sa.Integer(),
            nullable=True,
            comment="Q16, My baby is the most beautiful baby in the world (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q17",
            sa.Integer(),
            nullable=True,
            comment="Q17, I wish my baby would somehow go away (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q18",
            sa.Integer(),
            nullable=True,
            comment="Q18, I have done harmful things to my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q19",
            sa.Integer(),
            nullable=True,
            comment="Q19, My baby makes me anxious (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q20",
            sa.Integer(),
            nullable=True,
            comment="Q20, I am afraid of my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q21",
            sa.Integer(),
            nullable=True,
            comment="Q21, My baby annoys me (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q22",
            sa.Integer(),
            nullable=True,
            comment="Q22, I feel confident when changing my baby (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "q23",
            sa.Integer(),
            nullable=True,
            comment="Q23, I feel the only solution is for someone else to look after my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q24",
            sa.Integer(),
            nullable=True,
            comment="Q24, I feel like hurting my baby (always 5 - never 0, higher worse)",
        ),
        sa.Column(
            "q25",
            sa.Integer(),
            nullable=True,
            comment="Q25, My baby is easily comforted (always 0 - never 5, higher worse)",
        ),
        sa.Column(
            "patient_id",
            sa.Integer(),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_pbq__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_pbq__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_pbq__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_pbq__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_pbq__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_pbq__removing_user_id"),
        ),
    ...
    with op.batch_alter_table("pbq", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_pbq__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_pbq__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_pbq__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_pbq__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_pbq__pk"), ["_pk"], unique=False)
        batch_op.create_index(batch_op.f("ix_pbq_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_pbq_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_pbq_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
