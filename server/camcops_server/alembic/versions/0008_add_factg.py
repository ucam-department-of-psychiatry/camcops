...
def upgrade():
    ...
    sa.Column('ignore_q7', sa.Boolean(), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('factg', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_factg_when_last_modified'))
        batch_op.drop_index(batch_op.f('ix_factg_patient_id'))
        batch_op.drop_index(batch_op.f('ix_factg_id'))
        batch_op.drop_index(batch_op.f('ix_factg__pk'))
        batch_op.drop_index(batch_op.f('ix_factg__group_id'))
        batch_op.drop_index(batch_op.f('ix_factg__era'))
        batch_op.drop_index(batch_op.f('ix_factg__device_id'))
        batch_op.drop_index(batch_op.f('ix_factg__current'))
