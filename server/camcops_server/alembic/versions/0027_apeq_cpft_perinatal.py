...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q1. Treated with respect/dignity (0 no, 1 yes to some extent,"
                " 2 yes)"
            ),
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q3. Needs were understood (0 no, 1 yes to some extent, 2 yes)"
            ),
        ),
        sa.Column(
            "q4",
            ...
            nullable=True,
            comment=(
                "Q4. Given info about team (0 no, 1 yes to some extent, 2 yes)"
            ),
        ),
        sa.Column(
            "q5",
            ...
            nullable=True,
            comment=(
                "Q5. Family considered/included (0 no, 1 yes to some extent, 2"
                " yes)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "Q6. Views on treatment taken into account (0 no, 1 yes to"
                " some extent, 2 yes)"
            ),
        ),
        sa.Column(
            ...
            nullable=True,
            comment=(
                "How likely to recommend service to friends and family (0"
                " don't know, 1 extremely unlikely, 2 unlikely, 3 neither"
