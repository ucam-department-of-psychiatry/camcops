...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Q1. Treated with respect/dignity (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "q2",
            sa.Integer(),
            nullable=True,
            comment="Q2. Felt listened to (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "q3",
            sa.Integer(),
            nullable=True,
            comment="Q3. Needs were understood (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "q4",
            sa.Integer(),
            nullable=True,
            comment="Q4. Given info about team (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "q5",
            sa.Integer(),
            nullable=True,
            comment="Q5. Family considered/included (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "q6",
            sa.Integer(),
            nullable=True,
            comment="Q6. Views on treatment taken into account (0 no, 1 yes to some extent, 2 yes)",
        ),
        sa.Column(
            "ff_rating",
            sa.Integer(),
            nullable=True,
            comment="How likely to recommend service to friends and family (0 don't know, 1 extremely unlikely, 2 unlikely, 3 neither likely nor unlikely, 4 likely, 5 extremely likely)",
        ),
        sa.Column(
            "ff_why",
            sa.UnicodeText(),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_apeq_cpft_perinatal__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_apeq_cpft_perinatal__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_apeq_cpft_perinatal__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_apeq_cpft_perinatal__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_apeq_cpft_perinatal__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_apeq_cpft_perinatal__removing_user_id"),
        ),
    ...
    with op.batch_alter_table("apeq_cpft_perinatal", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal__current"),
            ["_current"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal__device_id"),
            ["_device_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal__group_id"),
            ["_group_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal_id"), ["id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_apeq_cpft_perinatal_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
