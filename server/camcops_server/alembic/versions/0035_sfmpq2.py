...
Revision ID: 0035
Revises: 0034
Creation date: 2019-07-23 14:40:46.002060
...
def upgrade():
    ...
    op.create_table(
        'sfmpq2',
        sa.Column('q1', sa.Integer(), nullable=True, comment='Q1 (throbbing) (0 none - 10 worst)'),
        sa.Column('q2', sa.Integer(), nullable=True, comment='Q2 (shooting) (0 none - 10 worst)'),
        sa.Column('q3', sa.Integer(), nullable=True, comment='Q3 (stabbing) (0 none - 10 worst)'),
        sa.Column('q4', sa.Integer(), nullable=True, comment='Q4 (sharp) (0 none - 10 worst)'),
        sa.Column('q5', sa.Integer(), nullable=True, comment='Q5 (cramping) (0 none - 10 worst)'),
        sa.Column('q6', sa.Integer(), nullable=True, comment='Q6 (gnawing) (0 none - 10 worst)'),
        sa.Column('q7', sa.Integer(), nullable=True, comment='Q7 (hot-burning) (0 none - 10 worst)'),
        sa.Column('q8', sa.Integer(), nullable=True, comment='Q8 (aching) (0 none - 10 worst)'),
        sa.Column('q9', sa.Integer(), nullable=True, comment='Q9 (heavy) (0 none - 10 worst)'),
        sa.Column('q10', sa.Integer(), nullable=True, comment='Q10 (tender) (0 none - 10 worst)'),
        sa.Column('q11', sa.Integer(), nullable=True, comment='Q11 (splitting) (0 none - 10 worst)'),
        sa.Column('q12', sa.Integer(), nullable=True, comment='Q12 (tiring–exhausting) (0 none - 10 worst)'),
        sa.Column('q13', sa.Integer(), nullable=True, comment='Q13 (sickening) (0 none - 10 worst)'),
        sa.Column('q14', sa.Integer(), nullable=True, comment='Q14 (fearful) (0 none - 10 worst)'),
        sa.Column('q15', sa.Integer(), nullable=True, comment='Q15 (punishing–cruel) (0 none - 10 worst)'),
        sa.Column('q16', sa.Integer(), nullable=True, comment='Q16 (electric-shock) (0 none - 10 worst)'),
        sa.Column('q17', sa.Integer(), nullable=True, comment='Q17 (cold-freezing) (0 none - 10 worst)'),
        sa.Column('q18', sa.Integer(), nullable=True, comment='Q18 (piercing) (0 none - 10 worst)'),
        sa.Column('q19', sa.Integer(), nullable=True, comment='Q19 (light touch) (0 none - 10 worst)'),
        sa.Column('q20', sa.Integer(), nullable=True, comment='Q20 (itching) (0 none - 10 worst)'),
        sa.Column('q21', sa.Integer(), nullable=True, comment='Q21 (tingling) (0 none - 10 worst)'),
        sa.Column('q22', sa.Integer(), nullable=True, comment='Q22 (numbness) (0 none - 10 worst)'),
