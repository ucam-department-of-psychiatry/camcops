...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Q1 (throbbing) (0 none - 10 worst)",
        ),
        sa.Column(
            "q2",
            sa.Integer(),
            nullable=True,
            comment="Q2 (shooting) (0 none - 10 worst)",
        ),
        sa.Column(
            "q3",
            sa.Integer(),
            nullable=True,
            comment="Q3 (stabbing) (0 none - 10 worst)",
        ),
        sa.Column(
            "q4",
            sa.Integer(),
            nullable=True,
            comment="Q4 (sharp) (0 none - 10 worst)",
        ),
        sa.Column(
            "q5",
            sa.Integer(),
            nullable=True,
            comment="Q5 (cramping) (0 none - 10 worst)",
        ),
        sa.Column(
            "q6",
            sa.Integer(),
            nullable=True,
            comment="Q6 (gnawing) (0 none - 10 worst)",
        ),
        sa.Column(
            "q7",
            sa.Integer(),
            nullable=True,
            comment="Q7 (hot-burning) (0 none - 10 worst)",
        ),
        sa.Column(
            "q8",
            sa.Integer(),
            nullable=True,
            comment="Q8 (aching) (0 none - 10 worst)",
        ),
        sa.Column(
            "q9",
            sa.Integer(),
            nullable=True,
            comment="Q9 (heavy) (0 none - 10 worst)",
        ),
        sa.Column(
            "q10",
            sa.Integer(),
            nullable=True,
            comment="Q10 (tender) (0 none - 10 worst)",
        ),
        sa.Column(
            "q11",
            sa.Integer(),
            nullable=True,
            comment="Q11 (splitting) (0 none - 10 worst)",
        ),
        sa.Column(
            "q12",
            sa.Integer(),
            nullable=True,
            comment="Q12 (tiring–exhausting) (0 none - 10 worst)",
        ),
        sa.Column(
            "q13",
            sa.Integer(),
            nullable=True,
            comment="Q13 (sickening) (0 none - 10 worst)",
        ),
        sa.Column(
            "q14",
            sa.Integer(),
            nullable=True,
            comment="Q14 (fearful) (0 none - 10 worst)",
        ),
        sa.Column(
            "q15",
            sa.Integer(),
            nullable=True,
            comment="Q15 (punishing–cruel) (0 none - 10 worst)",
        ),
        sa.Column(
            "q16",
            sa.Integer(),
            nullable=True,
            comment="Q16 (electric-shock) (0 none - 10 worst)",
        ),
        sa.Column(
            "q17",
            sa.Integer(),
            nullable=True,
            comment="Q17 (cold-freezing) (0 none - 10 worst)",
        ),
        sa.Column(
            "q18",
            sa.Integer(),
            nullable=True,
            comment="Q18 (piercing) (0 none - 10 worst)",
        ),
        sa.Column(
            "q19",
            sa.Integer(),
            nullable=True,
            comment="Q19 (light touch) (0 none - 10 worst)",
        ),
        sa.Column(
            "q20",
            sa.Integer(),
            nullable=True,
            comment="Q20 (itching) (0 none - 10 worst)",
        ),
        sa.Column(
            "q21",
            sa.Integer(),
            nullable=True,
            comment="Q21 (tingling) (0 none - 10 worst)",
        ),
        sa.Column(
            "q22",
            sa.Integer(),
            nullable=True,
            comment="Q22 (numbness) (0 none - 10 worst)",
        ),
        sa.Column(
            "patient_id",
            sa.Integer(),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_sfmpq2__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_sfmpq2__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_sfmpq2__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_sfmpq2__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_sfmpq2__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_sfmpq2__removing_user_id"),
        ),
    ...
    with op.batch_alter_table("sfmpq2", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_sfmpq2__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sfmpq2__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sfmpq2__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sfmpq2__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sfmpq2__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_sfmpq2_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_sfmpq2_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sfmpq2_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
