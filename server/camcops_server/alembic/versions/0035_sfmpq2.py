...
"""
camcops_server/alembic/versions/0035_sfmpq2.py
...
Revision ID: 0035
Revises: 0034
Creation date: 2019-07-23 12:27:07.137010
...
def upgrade():
    ...
    op.create_table(
        'sfmpq2',
        sa.Column('q1', sa.Integer(), nullable=True, comment='Q1 (Pain description 1) (0 none - 10 worst)'),
        sa.Column('q2', sa.Integer(), nullable=True, comment='Q2 (Pain description 2) (0 none - 10 worst)'),
        sa.Column('q3', sa.Integer(), nullable=True, comment='Q3 (Pain description 3) (0 none - 10 worst)'),
        sa.Column('q4', sa.Integer(), nullable=True, comment='Q4 (Pain description 4) (0 none - 10 worst)'),
        sa.Column('q5', sa.Integer(), nullable=True, comment='Q5 (Pain description 5) (0 none - 10 worst)'),
        sa.Column('q6', sa.Integer(), nullable=True, comment='Q6 (Pain description 6) (0 none - 10 worst)'),
        sa.Column('q7', sa.Integer(), nullable=True, comment='Q7 (Pain description 7) (0 none - 10 worst)'),
        sa.Column('q8', sa.Integer(), nullable=True, comment='Q8 (Pain description 8) (0 none - 10 worst)'),
        sa.Column('q9', sa.Integer(), nullable=True, comment='Q9 (Pain description 9) (0 none - 10 worst)'),
        sa.Column('q10', sa.Integer(), nullable=True, comment='Q10 (Pain description 10) (0 none - 10 worst)'),
        sa.Column('q11', sa.Integer(), nullable=True, comment='Q11 (Pain description 11) (0 none - 10 worst)'),
        sa.Column('q12', sa.Integer(), nullable=True, comment='Q12 (Pain description 12) (0 none - 10 worst)'),
        sa.Column('q13', sa.Integer(), nullable=True, comment='Q13 (Pain description 13) (0 none - 10 worst)'),
        sa.Column('q14', sa.Integer(), nullable=True, comment='Q14 (Pain description 14) (0 none - 10 worst)'),
        sa.Column('q15', sa.Integer(), nullable=True, comment='Q15 (Pain description 15) (0 none - 10 worst)'),
        sa.Column('q16', sa.Integer(), nullable=True, comment='Q16 (Pain description 16) (0 none - 10 worst)'),
        sa.Column('q17', sa.Integer(), nullable=True, comment='Q17 (Pain description 17) (0 none - 10 worst)'),
        sa.Column('q18', sa.Integer(), nullable=True, comment='Q18 (Pain description 18) (0 none - 10 worst)'),
        sa.Column('q19', sa.Integer(), nullable=True, comment='Q19 (Pain description 19) (0 none - 10 worst)'),
        sa.Column('q20', sa.Integer(), nullable=True, comment='Q20 (Pain description 20) (0 none - 10 worst)'),
        sa.Column('q21', sa.Integer(), nullable=True, comment='Q21 (Pain description 21) (0 none - 10 worst)'),
        sa.Column('q22', sa.Integer(), nullable=True, comment='Q22 (Pain description 22) (0 none - 10 worst)'),
        ...
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_sfmpq2__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_sfmpq2__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_sfmpq2__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_sfmpq2__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_sfmpq2__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_sfmpq2__removing_user_id')),
        sa.PrimaryKeyConstraint('_pk', name=op.f('pk_sfmpq2')),
        mysql_charset='utf8mb4 COLLATE utf8mb4_unicode_ci',
        mysql_engine='InnoDB',
        mysql_row_format='DYNAMIC'
    )
    with op.batch_alter_table('sfmpq2', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_sfmpq2__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sfmpq2_when_last_modified'), ['when_last_modified'], unique=False)


# noinspection PyPep8,PyTypeChecker
def downgrade():
    op.drop_table('sfmpq2')
