...
"""
camcops_server/alembic/versions/0016.py
...
Revision ID: 0016
Revises: 0015
Creation date: 2019-01-31 15:01:26.815869
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_gbogrs__adding_user_id')),
    sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_gbogrs__device_id')),
    sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_gbogrs__group_id')),
    sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_gbogrs__manually_erasing_user_id')),
    sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_gbogrs__preserving_user_id')),
    sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_gbogrs__removing_user_id')),
    sa.PrimaryKeyConstraint('_pk', name=op.f('pk_gbogrs')),
    mysql_charset='utf8mb4 COLLATE utf8mb4_unicode_ci',
    mysql_engine='InnoDB',
    mysql_row_format='DYNAMIC'
    )
    with op.batch_alter_table('gbogrs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_gbogrs__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogrs_when_last_modified'), ['when_last_modified'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('gbogrs', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_gbogrs_when_last_modified'))
        batch_op.drop_index(batch_op.f('ix_gbogrs_patient_id'))
        batch_op.drop_index(batch_op.f('ix_gbogrs_id'))
        batch_op.drop_index(batch_op.f('ix_gbogrs__pk'))
        batch_op.drop_index(batch_op.f('ix_gbogrs__group_id'))
        batch_op.drop_index(batch_op.f('ix_gbogrs__era'))
        batch_op.drop_index(batch_op.f('ix_gbogrs__device_id'))
        batch_op.drop_index(batch_op.f('ix_gbogrs__current'))

    op.drop_table('gbogrs')
    # ### end Alembic commands ###
