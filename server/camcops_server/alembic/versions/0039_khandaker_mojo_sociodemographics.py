...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_khandaker_mojo_sociodemographics__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_khandaker_mojo_sociodemographics__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_khandaker_mojo_sociodemographics__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_khandaker_mojo_sociodemographics__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_khandaker_mojo_sociodemographics__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_khandaker_mojo_sociodemographics__removing_user_id')),
        sa.PrimaryKeyConstraint('_pk', name=op.f('pk_khandaker_mojo_sociodemographics')),
        mysql_charset='utf8mb4 COLLATE utf8mb4_unicode_ci',
        mysql_engine='InnoDB',
        mysql_row_format='DYNAMIC'
    )
    with op.batch_alter_table('khandaker_mojo_sociodemographics', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_khandaker_mojo_sociodemographics_when_last_modified'), ['when_last_modified'], unique=False)
