...
"""
camcops_server/alembic/versions/0074_isaaqed.py
...
Revision ID: 0074
Revises: 0073
Creation date: 2022-07-15 12:06:27.227888
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="e12 - fitspiration 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e13",
            sa.Integer(),
            nullable=True,
            comment="e13 - thinspiration 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e14",
            sa.Integer(),
            nullable=True,
            comment="e14 - bonespiration 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e15",
            sa.Integer(),
            nullable=True,
            comment="e15 - online dating 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e16",
            sa.Integer(),
            nullable=True,
            comment="e16 - calorie tracking 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e17",
            sa.Integer(),
            nullable=True,
            comment="e17 - fitness tracking 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e18",
            sa.Integer(),
            nullable=True,
            comment=(
                "e18 - cyberbullying victimization 0-5 (not at all - all the"
                " time)"
            ),
        ),
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="e19 - mukbang 0-5 (not at all - all the time)",
        ),
        sa.Column(
            "e20",
            sa.Integer(),
            nullable=True,
            comment=(
                "e20 - appearance-focused gaming 0-5 (not at all - all the"
                " time)"
            ),
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_isaaqed__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_isaaqed__device_id"),
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_isaaqed__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_isaaqed__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_isaaqed__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_isaaqed__removing_user_id"),
        ),
        sa.PrimaryKeyConstraint("_pk", name=op.f("pk_isaaqed")),
    ...
    with op.batch_alter_table("isaaqed", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_isaaqed__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed_id"), ["id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_isaaqed_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
    ...
    with op.batch_alter_table("isaaqed", schema=None) as batch_op:
        batch_op.create_foreign_key(
            batch_op.f("fk_isaaqed__device_id"),
            "_security_devices",
            ["_device_id"],
            ["id"],
            use_alter=True,
