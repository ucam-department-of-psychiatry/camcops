...
Revision ID: 0042
Revises: 0041
Creation date: 2019-09-15 14:15:45.675198
...
def upgrade():
    op.create_table('lynall_iam_life',
        ...
        sa.Column('q8_main', sa.Boolean(), nullable=True, comment='Q8: in last 6 months: sacked/made redundant (0 no, 1 yes)'),
        ...
        sa.Column('q8_frequency', sa.Integer(), nullable=True, comment='Q8: Since age 18, how many times has this happened to you in total?'),
        sa.Column('q9_main', sa.Boolean(), nullable=True, comment='Q9: in last 6 months: unsuccessful job-seeking for >1 month (0 no, 1 yes)'),
        ...
        sa.Column('q9_frequency', sa.Integer(), nullable=True, comment='Q9: For what percentage of your life since aged 18 has [this event: unsuccessful job-seeking for >1 month] been happening? (0-100)'),
