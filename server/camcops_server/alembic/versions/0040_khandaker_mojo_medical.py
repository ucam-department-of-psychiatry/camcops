...
"""
camcops_server/alembic/versions/0040_khandaker_mojo_medical.py
...
Revision ID: 0040
Revises: 0039
Creation date: 2019-08-20 10:31:51.551475
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Diagnosis (0 Rheumatoid Arthritis, 1 Ankylosing Spondylitis, 2 Sjögren’s Syndrome)",
        ),
        sa.Column(
            "diagnosis_date",
            sa.Date(),
            nullable=True,
            comment="Date of first diagnosis (may be approx from 'duration of illness (years))'",
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            sa.Boolean(),
            nullable=True,
            comment="Are you, or is there any possibility that you might be pregnant?",
        ),
        sa.Column(
            "has_infection_past_month",
            sa.Boolean(),
            nullable=True,
            comment="Do you currently have an infection, or had treatment for an infection (e.g antibiotics) in the past month?",
        ),
        sa.Column(
            "had_infection_two_months_preceding",
            sa.Boolean(name="ck_kh2mm_had_infection"),
            nullable=True,
            comment="Have you had an infection, or had treatment for an infection (e.g antibiotics) in the 2 months preceding last month?",
        ),
        sa.Column(
            "has_alcohol_substance_dependence",
            sa.Boolean(name="ck_kh2mm_has_alcohol"),
            nullable=True,
            comment="Do you have a current diagnosis of alcohol or substance dependence?",
        ),
        sa.Column(
            "smoking_status",
            sa.Integer(),
            nullable=True,
            comment="What is your smoking status? (0 Never smoked, 1 Ex-smoker, 2 Current smoker)",
        ),
        sa.Column(
            "alcohol_units_per_week",
            sa.Float(),
            nullable=True,
            comment="How much alcohol do you drink per week? (medium glass of wine = 2 units, pint of beer at 4.5% = 2.5 units, 25ml of spirits at 40% = 1 unit)",
        ),
        sa.Column(
            "depression",
            sa.Boolean(),
            nullable=True,
            comment="Have you had any of the following conditions diagnosed by a doctor?",
        ),
        sa.Column(
            "bipolar_disorder",
            sa.Boolean(),
        ...
        sa.Column(
            "other_mental_illness_details",
            sa.UnicodeText(),
            nullable=True,
            comment="If other, please list here",
        ),
        sa.Column(
            "hospitalised_in_last_year",
            sa.Boolean(),
            nullable=True,
            comment="Have you had a physical or mental illness requiring hospitalisation in the previous 12 months?",
        ),
        sa.Column(
            "hospitalisation_details",
            sa.UnicodeText(),
            nullable=True,
            comment="If yes, please list here (name of illness, number of hospitilisations and duration):",
        ),
        sa.Column(
            "family_depression",
            sa.Boolean(),
            nullable=True,
            comment="Has anyone in your immediate family (parents, siblings or children) had any of the following conditions diagnosed by a doctor?",
        ),
        sa.Column(
            "family_bipolar_disorder",
            sa.Boolean(),
            nullable=True,
            comment="Has anyone in your immediate family (parents, siblings or children) had any of the following conditions diagnosed by a doctor?",
        ),
        ...
        sa.Column(
            "family_personality_disorder",
            sa.Boolean(),
            nullable=True,
            comment="Has anyone in your immediate family (parents, siblings or children) had any of the following conditions diagnosed by a doctor?",
        ),
        sa.Column(
            "family_intellectual_disability",
            sa.Boolean(name="ck_kh2mm_fam_int_dis"),
            nullable=True,
            comment="Has anyone in your immediate family (parents, siblings or children) had any of the following conditions diagnosed by a doctor?",
        ),
        sa.Column(
            "family_other_mental_illness",
            sa.Boolean(),
            nullable=True,
            comment="Has anyone in your immediate family (parents, siblings or children) had any of the following conditions diagnosed by a doctor?",
        ),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_mojo_medical__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_khandaker_mojo_medical__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_khandaker_mojo_medical__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_mojo_medical__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_mojo_medical__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_mojo_medical__removing_user_id"),
        ),
        sa.PrimaryKeyConstraint("_pk", name=op.f("pk_khandaker_mojo_medical")),
        mysql_charset="utf8mb4 COLLATE utf8mb4_unicode_ci",
        mysql_engine="InnoDB",
        mysql_row_format="DYNAMIC",
    )
    with op.batch_alter_table(
        "khandaker_mojo_medical", schema=None
    ) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical__current"),
            ["_current"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical__device_id"),
            ["_device_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical__era"),
            ["_era"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical__group_id"),
            ["_group_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical_id"), ["id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical_patient_id"),
            ["patient_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_mojo_medical_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
...
# noinspection PyPep8,PyTypeChecker
def downgrade():
    op.drop_table("khandaker_mojo_medical")
