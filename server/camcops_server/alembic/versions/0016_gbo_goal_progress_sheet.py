...
gbo goal progress sheet

Revision ID: 0016
Revises: 0015
Creation date: 2019-02-08 10:26:25.581084
...
def upgrade():
    ...
    op.create_table('gbogprs',
    sa.Column('q_date', sa.Date(), nullable=True),
    sa.Column('q_session', sa.Integer(), nullable=True),
    sa.Column('q_goal', sa.UnicodeText(), nullable=True),
    sa.Column('q_progress', sa.UnicodeText(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_gbogprs__adding_user_id')),
    sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_gbogprs__device_id')),
    sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_gbogprs__group_id')),
    sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_gbogprs__manually_erasing_user_id')),
    sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_gbogprs__preserving_user_id')),
    sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_gbogprs__removing_user_id')),
    sa.PrimaryKeyConstraint('_pk', name=op.f('pk_gbogprs')),
    mysql_charset='utf8mb4 COLLATE utf8mb4_unicode_ci',
    mysql_engine='InnoDB',
    mysql_row_format='DYNAMIC'
    )
    with op.batch_alter_table('gbogprs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_gbogprs__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_gbogprs_when_last_modified'), ['when_last_modified'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('gbogprs', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_gbogprs_when_last_modified'))
        batch_op.drop_index(batch_op.f('ix_gbogprs_patient_id'))
        batch_op.drop_index(batch_op.f('ix_gbogprs_id'))
        batch_op.drop_index(batch_op.f('ix_gbogprs__pk'))
        batch_op.drop_index(batch_op.f('ix_gbogprs__group_id'))
        batch_op.drop_index(batch_op.f('ix_gbogprs__era'))
        batch_op.drop_index(batch_op.f('ix_gbogprs__device_id'))
        batch_op.drop_index(batch_op.f('ix_gbogprs__current'))

    op.drop_table('gbogprs')
    # ### end Alembic commands ###
