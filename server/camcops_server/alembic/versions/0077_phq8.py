...
"""
camcops_server/alembic/versions/0077_phq8.py
...
Revision ID: 0077
Revises: 0076
Creation date: 2022-11-30 15:31:19.022587
...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Q6 (self-esteem/guilt) (0 not at all - "
            "3 nearly every day)",
        ),
        sa.Column(
            "q7",
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_phq8__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_phq8__device_id"),
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_phq8__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_phq8__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_phq8__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_phq8__removing_user_id"),
        ),
        sa.PrimaryKeyConstraint("_pk", name=op.f("pk_phq8")),
    ...
    with op.batch_alter_table("phq8", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_phq8__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_phq8__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_phq8__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_phq8__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_phq8__pk"), ["_pk"], unique=False)
        batch_op.create_index(batch_op.f("ix_phq8_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_phq8_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_phq8_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
