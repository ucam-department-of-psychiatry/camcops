...
"""
camcops_server/alembic/versions/0017.py
...
Revision ID: 0017
Revises: 0016
Creation date: 2019-01-31 23:22:06.093459
...
def upgrade():
    ...
    with op.batch_alter_table('gbogrs', schema=None) as batch_op:
        ...
        batch_op.drop_column('respondent_relationship')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('gbogrs', schema=None) as batch_op:
        batch_op.add_column(sa.Column('respondent_relationship', mysql.TEXT(collation='utf8mb4_unicode_ci'), nullable=True))
        batch_op.add_column(sa.Column('respondent_name', mysql.TEXT(collation='utf8mb4_unicode_ci'), nullable=True))
