...
def upgrade():
    op.create_table(
        'suppsp',
        sa.Column('q1', sa.Integer(), nullable=True, comment='Q1 (see to end) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q2', sa.Integer(), nullable=True, comment='Q2 (careful and purposeful) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q3', sa.Integer(), nullable=True, comment='Q3 (problem situations) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q4', sa.Integer(), nullable=True, comment='Q4 (unfinished bother) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q5', sa.Integer(), nullable=True, comment='Q5 (stop and think) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q6', sa.Integer(), nullable=True, comment='Q6 (do things regret) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q7', sa.Integer(), nullable=True, comment='Q7 (hate to stop) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q8', sa.Integer(), nullable=True, comment="Q8 (can't stop what I'm doing) (1 strongly disagree - 4 strongly agree)"),
        sa.Column('q9', sa.Integer(), nullable=True, comment='Q9 (enjoy risks) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q10', sa.Integer(), nullable=True, comment='Q10 (lose control) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q11', sa.Integer(), nullable=True, comment='Q11 (finish) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q12', sa.Integer(), nullable=True, comment='Q12 (rational sensible) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q13', sa.Integer(), nullable=True, comment='Q13 (act without thinking upset) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q14', sa.Integer(), nullable=True, comment='Q14 (new and exciting) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q15', sa.Integer(), nullable=True, comment='Q15 (say things regret) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q16', sa.Integer(), nullable=True, comment='Q16 (airplane) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q17', sa.Integer(), nullable=True, comment='Q17 (others shocked) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q18', sa.Integer(), nullable=True, comment='Q18 (skiing) (1 strongly disagree - 4 strongly agree)'),
        sa.Column('q19', sa.Integer(), nullable=True, comment='Q19 (think carefully) (1 strongly agree - 4 strongly disagree)'),
        sa.Column('q20', sa.Integer(), nullable=True, comment='Q20 (act without thinking excited) (1 strongly disagree - 4 strongly agree)'),
        ...
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_suppsp__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_suppsp__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_suppsp__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_suppsp__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_suppsp__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_suppsp__removing_user_id')),
    ...
    with op.batch_alter_table('suppsp', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_suppsp__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_suppsp_when_last_modified'), ['when_last_modified'], unique=False)
