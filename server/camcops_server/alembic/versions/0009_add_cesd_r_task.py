...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('cesdr', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_cesdr_when_last_modified'))
        batch_op.drop_index(batch_op.f('ix_cesdr_patient_id'))
        batch_op.drop_index(batch_op.f('ix_cesdr_id'))
        batch_op.drop_index(batch_op.f('ix_cesdr__pk'))
        batch_op.drop_index(batch_op.f('ix_cesdr__group_id'))
        batch_op.drop_index(batch_op.f('ix_cesdr__era'))
        batch_op.drop_index(batch_op.f('ix_cesdr__device_id'))
        batch_op.drop_index(batch_op.f('ix_cesdr__current'))
