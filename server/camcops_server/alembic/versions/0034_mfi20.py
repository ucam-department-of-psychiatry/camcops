...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Q1 (feel fit) (1 yes - 5 no)",
        ),
        sa.Column(
            "q2",
            sa.Integer(),
            nullable=True,
            comment="Q2 (physically little) (1 yes - 5 no)",
        ),
        sa.Column(
            "q3",
            sa.Integer(),
            nullable=True,
            comment="Q3 (feel active) (1 yes - 5 no)",
        ),
        sa.Column(
            "q4",
            sa.Integer(),
            nullable=True,
            comment="Q4 (nice things) (1 yes - 5 no)",
        ),
        sa.Column(
            "q5",
            sa.Integer(),
            nullable=True,
            comment="Q5 (tired) (1 yes - 5 no)",
        ),
        sa.Column(
            "q6",
            sa.Integer(),
            nullable=True,
            comment="Q6 (do a lot) (1 yes - 5 no)",
        ),
        sa.Column(
            "q7",
            sa.Integer(),
            nullable=True,
            comment="Q7 (keep thought on) (1 yes - 5 no)",
        ),
        sa.Column(
            "q8",
            sa.Integer(),
            nullable=True,
            comment="Q8 (take on a lot) (1 yes - 5 no)",
        ),
        sa.Column(
            "q9",
            sa.Integer(),
            nullable=True,
            comment="Q9 (dread) (1 yes - 5 no)",
        ),
        sa.Column(
            "q10",
            sa.Integer(),
            nullable=True,
            comment="Q10 (think little) (1 yes - 5 no)",
        ),
        sa.Column(
            "q11",
            sa.Integer(),
            nullable=True,
            comment="Q11 (concentrate) (1 yes - 5 no)",
        ),
        sa.Column(
            "q12",
            sa.Integer(),
            nullable=True,
            comment="Q12 (rested) (1 yes - 5 no)",
        ),
        sa.Column(
            "q13",
            sa.Integer(),
            nullable=True,
            comment="Q13 (effort concentrate) (1 yes - 5 no)",
        ),
        sa.Column(
            "q14",
            sa.Integer(),
            nullable=True,
            comment="Q14 (bad condition) (1 yes - 5 no)",
        ),
        sa.Column(
            "q15",
            sa.Integer(),
            nullable=True,
            comment="Q15 (plans) (1 yes - 5 no)",
        ),
        sa.Column(
            "q16",
            sa.Integer(),
            nullable=True,
            comment="Q16 (tire) (1 yes - 5 no)",
        ),
        sa.Column(
            "q17",
            sa.Integer(),
            nullable=True,
            comment="Q17 (get little done) (1 yes - 5 no)",
        ),
        sa.Column(
            "q18",
            sa.Integer(),
            nullable=True,
            comment="Q18 (don't feel like) (1 yes - 5 no)",
        ),
        sa.Column(
            "q19",
            sa.Integer(),
            nullable=True,
            comment="Q19 (thoughts wander) (1 yes - 5 no)",
        ),
        sa.Column(
            "q20",
            sa.Integer(),
            nullable=True,
            comment="Q20 (excellent condition) (1 yes - 5 no)",
        ),
        sa.Column(
            "patient_id",
            sa.Integer(),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_mfi20__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_mfi20__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_mfi20__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_mfi20__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_mfi20__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_mfi20__removing_user_id"),
        ),
    ...
    with op.batch_alter_table("mfi20", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_mfi20__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_mfi20__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_mfi20__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_mfi20__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_mfi20__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_mfi20_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_mfi20_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_mfi20_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
