"""
camcops_server/alembic/versions/0088_aq10.py
...
Revision ID: 0088
Revises: 0087
Creation date: 2026-08-12 16:32:26.603020
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="q1 - notice small sounds",
        ),
        sa.Column(
            "q2",
            sa.Integer(),
            nullable=True,
            comment="q2 - concentrate more on whole picture",
        ),
        sa.Column(
            "q3",
            sa.Integer(),
            nullable=True,
            comment="q3 - easy to do more than one thing",
        ),
        sa.Column(
            "q4",
            sa.Integer(),
            nullable=True,
            comment="q4 - can switch back after interruption",
        ),
        sa.Column(
            "q5",
            sa.Integer(),
            nullable=True,
            comment="q5 - easy to read between the lines",
        ),
        sa.Column(
            "q6",
            sa.Integer(),
            nullable=True,
            comment="q6 - can tell if person listening is bored",
        ),
        sa.Column(
            "q7",
            sa.Integer(),
            nullable=True,
            comment="q7 - can't work out story characters’ intentions",
        ),
        sa.Column(
            "q8",
            sa.Integer(),
            nullable=True,
            comment="q8 - like to collect information about categories of things",  # noqa: E501
        ),
        sa.Column(
            "q9",
            sa.Integer(),
            nullable=True,
            comment="q9 - can work out thinking or feeling from face",
        ),
        sa.Column(
            "q10",
            sa.Integer(),
            nullable=True,
            comment="q10 - difficult to work out people’s intentions",
        ),
        sa.Column(
            "patient_id",
            sa.Integer(),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_aq10__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_aq10__device_id"),
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_aq10__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_aq10__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_aq10__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_aq10__removing_user_id"),
        ),
        sa.PrimaryKeyConstraint("_pk", name=op.f("pk_aq10")),
        mysql_charset="utf8mb4 COLLATE utf8mb4_unicode_ci",
        mysql_engine="InnoDB",
        mysql_row_format="DYNAMIC",
    )
    with op.batch_alter_table("aq10", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_aq10__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_aq10__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_aq10__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_aq10__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_aq10__pk"), ["_pk"], unique=False)
        batch_op.create_index(batch_op.f("ix_aq10_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_aq10_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_aq10_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
