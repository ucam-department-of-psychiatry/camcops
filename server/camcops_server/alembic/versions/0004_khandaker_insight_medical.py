...
"""
camcops_server/alembic/versions/0004_khandaker_insight_medical.py
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "cva_headinjury_braintumour_yn", sa.Boolean(), nullable=True
        ),
        sa.Column(
            "cva_headinjury_braintumour_comment",
            sa.UnicodeText(),
            nullable=True,
        ),
        ...
        sa.Column(
            "cerebralpalsy_otherbrain_comment", sa.UnicodeText(), nullable=True
        ),
        sa.Column("visual_impairment_yn", sa.Boolean(), nullable=True),
        sa.Column(
            "visual_impairment_comment", sa.UnicodeText(), nullable=True
        ),
        ...
        sa.Column(
            "other_inflammatory_comment", sa.UnicodeText(), nullable=True
        ),
        ...
        sa.Column(
            "other_endocrinological_comment", sa.UnicodeText(), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_1_medicalhistory__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_khandaker_1_medicalhistory__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_khandaker_1_medicalhistory__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f(
                "fk_khandaker_1_medicalhistory__manually_erasing_user_id"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_1_medicalhistory__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_khandaker_1_medicalhistory__removing_user_id"),
        ),
        sa.PrimaryKeyConstraint(
            "_pk", name=op.f("pk_khandaker_1_medicalhistory")
        ),
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory__current"),
            ["_current"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory__device_id"),
            ["_device_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory__era"),
            ["_era"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory__group_id"),
            ["_group_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory__pk"),
            ["_pk"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory_id"),
            ["id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory_patient_id"),
            ["patient_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_khandaker_1_medicalhistory_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
