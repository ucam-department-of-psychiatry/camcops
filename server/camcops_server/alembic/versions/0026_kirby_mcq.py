...
def upgrade():
    op.create_table('kirby_mcq',
        ...
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_kirby_mcq__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_kirby_mcq__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq__removing_user_id')),
    ...
    with op.batch_alter_table('kirby_mcq', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_kirby_mcq__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_patient_id'), ['patient_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_when_last_modified'), ['when_last_modified'], unique=False)

    op.create_table('kirby_mcq_trials',
        sa.Column('kirby_mcq_id', sa.Integer(), nullable=False, comment='FK to kirby_mcq'),
        sa.Column('trial', sa.Integer(), nullable=False, comment='Trial number (1-based)'),
        sa.Column('sir', sa.Integer(), nullable=True, comment='Small immediate reward'),
        sa.Column('ldr', sa.Integer(), nullable=True, comment='Large delayed reward'),
        sa.Column('delay_days', sa.Integer(), nullable=True, comment='Delay in days'),
        sa.Column('currency', sa.Unicode(length=3), nullable=True, comment='Currency symbol'),
        sa.Column('currency_symbol_first', sa.Boolean(), nullable=True, comment='Does the currency symbol come before the amount?'),
        sa.Column('chose_ldr', sa.Boolean(), nullable=True, comment='Did the subject choose the large delayed reward?'),
        sa.Column('_pk', sa.Integer(), autoincrement=True, nullable=False, comment='(SERVER) Primary key (on the server)'),
        sa.Column('_device_id', sa.Integer(), nullable=False, comment='(SERVER) ID of the source tablet device'),
        sa.Column('_era', sa.String(length=32), nullable=False, comment="(SERVER) 'NOW', or when this row was preserved and removed from the source device (UTC ISO 8601)"),
        sa.Column('_current', sa.Boolean(), nullable=False, comment='(SERVER) Is the row current (1) or not (0)?'),
        ...
        sa.Column('when_last_modified', camcops_server.cc_modules.cc_sqla_coltypes.PendulumDateTimeAsIsoTextColType(length=32), nullable=True, comment='(STANDARD) Date/time this row was last modified on the source tablet device (ISO 8601)'),
        sa.Column('_move_off_tablet', sa.Boolean(), nullable=True, comment='(SERVER/TABLET) Record-specific preservation pending?'),
        sa.ForeignKeyConstraint(['_adding_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq_trials__adding_user_id')),
        sa.ForeignKeyConstraint(['_device_id'], ['_security_devices.id'], name=op.f('fk_kirby_mcq_trials__device_id')),
        sa.ForeignKeyConstraint(['_group_id'], ['_security_groups.id'], name=op.f('fk_kirby_mcq_trials__group_id')),
        sa.ForeignKeyConstraint(['_manually_erasing_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq_trials__manually_erasing_user_id')),
        sa.ForeignKeyConstraint(['_preserving_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq_trials__preserving_user_id')),
        sa.ForeignKeyConstraint(['_removing_user_id'], ['_security_users.id'], name=op.f('fk_kirby_mcq_trials__removing_user_id')),
    ...
    with op.batch_alter_table('kirby_mcq_trials', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials__current'), ['_current'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials__device_id'), ['_device_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials__era'), ['_era'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials__group_id'), ['_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials__pk'), ['_pk'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_kirby_mcq_trials_when_last_modified'), ['when_last_modified'], unique=False)
