...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["_adding_user_id"],
            ["_security_users.id"],
            name=op.f("fk_core10__adding_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_device_id"],
            ["_security_devices.id"],
            name=op.f("fk_core10__device_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_group_id"],
            ["_security_groups.id"],
            name=op.f("fk_core10__group_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_manually_erasing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_core10__manually_erasing_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_preserving_user_id"],
            ["_security_users.id"],
            name=op.f("fk_core10__preserving_user_id"),
        ),
        sa.ForeignKeyConstraint(
            ["_removing_user_id"],
            ["_security_users.id"],
            name=op.f("fk_core10__removing_user_id"),
        ),
    ...
    with op.batch_alter_table("core10", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_core10__current"), ["_current"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_core10__device_id"), ["_device_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_core10__era"), ["_era"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_core10__group_id"), ["_group_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_core10__pk"), ["_pk"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_core10_id"), ["id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_core10_patient_id"), ["patient_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_core10_when_last_modified"),
            ["when_last_modified"],
            unique=False,
        )
