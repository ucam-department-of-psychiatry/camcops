...
def downgrade():
    ...
    sa.Column('owner', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=20), nullable=True),
    mysql_collate='utf8mb4_unicode_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
    with op.batch_alter_table('eq5d5l', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_eq5d5l_when_last_modified'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l_patient_id'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l_id'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l__pk'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l__group_id'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l__era'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l__device_id'))
        batch_op.drop_index(batch_op.f('ix_eq5d5l__current'))
