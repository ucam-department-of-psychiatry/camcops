...
class Fab(Task):
    ...
    def get_fieldspecs(cls):
        return STANDARD_TASK_FIELDSPECS + CLINICIAN_FIELDSPECS + Fab.TASK_FIELDSPECS
    ...
    def get_task_html(self):
        ...
        for q in range(1, Fab.NQUESTIONS + 1):
            ...
            for option in range(0, 5):
                d[option] = str(option) + u" — " + WSTRING("fab_q" + str(q) + "_option" + str(option))
        ...
        h = self.get_standard_clinician_block() + u"""
            ...
            <table class="taskdetail">
                <tr><th width="40%">Question</th><th width="60%">Score</th></tr>
        """.format(
        ...
        h += u"""
            ...
            <div class="footnotes">
                [1] Cutoff is &le;12.
                In patients with early dementia (MMSE > 24), a cutoff score of FAB &le;12 (*) can differentiate frontotemporal dementia from Alzheimer's disease (sensitivity for FTD 77%, specificy 87%; Slachevksy et al. 2004, PubMed ID 15262742).
