    ...
    def get_task_html(self):
        ...
        for q in Bfcrs.TASK_FIELDS:
            ...
            for option in range(0, 5):
                if (option != 0 and option != 3) and q in ["q17", "q18", "q19", "q20", "q21"]:
                    continue
        ...
        h = u"""
            ...
            <table class="taskdetail">
                <tr><th width="35%">Question</th><th width="65%">Answer</th></tr>
        """.format(
        ...
        for q in range(1, Bfcrs.NQUESTIONS + 1):
            h += u"""<tr><td>{}</td><td><b>{}</b></td></tr>""".format(
                ...
                get_from_dict( ANSWER_DICTS_DICT["q" + str(q)], getattr(self, "q" + str(q)) )
            )
        h += u"""
            </table>
            <div class="footnotes">
