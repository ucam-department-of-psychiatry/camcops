...
class Invalid(Exception):
    ...
    value: _Any = ...
    children: _Any = ...
    def __init__(self, node: _Any, msg: Optional[_Any] = ..., value: Optional[_Any] = ...) -> None: ...
    def messages(self): ...
    def add(self, exc: _Any, pos: Optional[_Any] = ...) -> None: ...
    def __setitem__(self, name: _Any, msg: _Any) -> None: ...
    def paths(self): ...
    def asdict(self, translate: Optional[_Any] = ..., separator: str = ...): ...

class UnsupportedFields(Invalid):
    fields: _Any = ...
    def __init__(self, node: _Any, fields: _Any, msg: Optional[_Any] = ...) -> None: ...
...
class Function:
    function: _Any = ...
    msg: _Any = ...
    def __init__(self, function: _Any, msg: Optional[_Any] = ..., message: Optional[_Any] = ...) -> None: ...
    def __call__(self, node: _Any, value: _Any) -> None: ...

class Regex:
    match_object: _Any = ...
    msg: _Any = ...
    def __init__(self, regex: _Any, msg: Optional[_Any] = ..., flags: int = ...) -> None: ...
    def __call__(self, node: _Any, value: _Any) -> None: ...
...
class Range:
    ...
    min_err: _Any = ...
    max_err: _Any = ...
    def __init__(self, min: Optional[_Any] = ..., max: Optional[_Any] = ..., min_err: _Any = ..., max_err: _Any = ...) -> None: ...
    def __call__(self, node: _Any, value: _Any) -> None: ...
...
class SchemaType:
    def flatten(self, node: _Any, appstruct: _Any, prefix: str = ..., listitem: bool = ...): ...
    def unflatten(self, node: _Any, paths: _Any, fstruct: _Any): ...
    def set_value(self, node: _Any, appstruct: _Any, path: _Any, value: _Any) -> None: ...
...
class Mapping(SchemaType):
    ...
    def flatten(self, node: _Any, appstruct: _Any, prefix: str = ..., listitem: bool = ...): ...
    def unflatten(self, node: _Any, paths: _Any, fstruct: _Any): ...
    def set_value(self, node: _Any, appstruct: _Any, path: _Any, value: _Any): ...
...
class Sequence(Positional, SchemaType):
    ...
    def cstruct_children(self, node: _Any, cstruct: _Any): ...
    def serialize(self, node: _Any, appstruct: _Any, accept_scalar: Optional[_Any] = ...): ...
    def deserialize(self, node: _Any, cstruct: _Any, accept_scalar: Optional[_Any] = ...): ...
    def flatten(self, node: _Any, appstruct: _Any, prefix: str = ..., listitem: bool = ...): ...
    def unflatten(self, node: _Any, paths: _Any, fstruct: _Any): ...
    def set_value(self, node: _Any, appstruct: _Any, path: _Any, value: _Any): ...
    def get_value(self, node: _Any, appstruct: _Any, path: _Any): ...
...
class String(SchemaType):
    encoding: _Any = ...
    allow_empty: _Any = ...
    def __init__(self, encoding: Optional[_Any] = ..., allow_empty: bool = ...) -> None: ...
    def serialize(self, node: _Any, appstruct: _Any): ...
    def deserialize(self, node: _Any, cstruct: _Any): ...
Str = String
...
class Decimal(Number):
    ...
    rounding: _Any = ...
    normalize: _Any = ...
    def __init__(self, quant: Optional[_Any] = ..., rounding: Optional[_Any] = ..., normalize: bool = ...) -> None: ...
...
class Boolean(SchemaType):
    ...
    true_reprs: _Any = ...
    false_reprs: _Any = ...
    def __init__(self, false_choices: _Any = ..., true_choices: _Any = ..., false_val: str = ..., true_val: str = ...) -> None: ...
    def serialize(self, node: _Any, appstruct: _Any): ...
    def deserialize(self, node: _Any, cstruct: _Any): ...
Bool = Boolean
...
class DateTime(SchemaType):
    ...
    default_tzinfo: _Any = ...
    format: _Any = ...
    def __init__(self, default_tzinfo: _Any = ..., format: Optional[_Any] = ...) -> None: ...
    def serialize(self, node: _Any, appstruct: _Any): ...
    def deserialize(self, node: _Any, cstruct: _Any): ...
...
class Enum(SchemaType):
    ...
    typ: _Any = ...
    values: _Any = ...
    def __init__(self, enum_cls: _Any, attr: Optional[_Any] = ..., typ: Optional[_Any] = ...) -> None: ...
    def serialize(self, node: _Any, appstruct: _Any): ...
    def deserialize(self, node: _Any, cstruct: _Any): ...
...
class _SchemaNode:
    ...
    def set_value(self, appstruct: _Any, dotted_name: _Any, value: _Any) -> None: ...
